# coding: utf-8
from sqlalchemy import BigInteger, Column, DECIMAL, Date, DateTime, Float, ForeignKey, ForeignKeyConstraint, Index, Integer, LargeBinary, NCHAR, String, Table, Unicode, text
from sqlalchemy.dialects.mssql import BIT, DATETIME2, IMAGE, MONEY, NTEXT, SMALLDATETIME, TINYINT, UNIQUEIDENTIFIER
...
class ACTION(Base):
    ...
    __table_args__ = (
        Index('IX_ACTION_P_ID_ACT_DISABLED_REPORT_SENT', 'P_ID', 'ACT_DISABLED', 'REPORT_SENT'),
        Index('IX_ACTION_ACT_READY_ACT_REMINDER_ACT_DISABLED_ACT_NEWDATE', 'ACT_READY', 'ACT_REMINDER', 'ACT_DISABLED', 'ACT_NEWDATE'),
        Index('IX_ACTION_SO_NUMBER_ACTT_ID_ACT_DISABLED', 'SO_NUMBER', 'ACTT_ID', 'ACT_DISABLED', 'P_ID'),
        Index('IX_ACTION_ACT_READY_ACT_DISABLED_ST_ID', 'ACT_READY', 'ACT_DISABLED', 'ST_ID'),
        {'schema': 'dbo'}
    )
...
class DISPO(Base):
    __tablename__ = 'DISPO'
    __table_args__ = (
        Index('IX_DISPO_WOC_IAN_DISABLED_PROCESS', 'PROCESS', 'IAN', 'DISABLED', 'WOC'),
        {'schema': 'dbo'}
    )
...
class FOLDERRIGHTSMANAGEMENTTASKDATUM(Base):
    ...
    __table_args__ = (
        Index('IX_FOLDERRIGHTSMANAGEMENT_TASK_DATA_PROJECT_TASK', 'RIGHTSMANAGEMENTTASK', 'PROJECT'),
        {'schema': 'dbo'}
    )
...
class HIERARCHY(Base):
    ...
    __table_args__ = (
        Index('IX_HIERARCHY_HR_ACTIVE_HR_PARENT', 'HR_ACTIVE', 'HR_PARENT', 'HR_ID'),
        Index('IX_HIERARCHY_HR_TYPE', 'HR_TYPE', 'HR_ID', 'HR_LOCATION', 'HR_ACTIVE', 'HR_PARENT', 'HR_NEW_ID', 'IS_PLACEHOLDER', 'ST_ID', 'CC_ID', 'CREATED', 'CREATED_BY', 'HR_LAST_UPDATED', 'UPDATED_BY'),
        Index('IX_HIERARCHY_HR_ACTIVE_HR_TYPE', 'HR_ACTIVE', 'HR_TYPE', 'HR_ID', 'HR_LOCATION', 'HR_NEW_ID'),
        {'schema': 'dbo'}
    )
    ...
    STAFF = relationship('STAFF', primaryjoin='HIERARCHY.CREATED_BY == STAFF.ST_ID')
    STAFF1 = relationship('STAFF', primaryjoin='HIERARCHY.ST_ID == STAFF.ST_ID')
    STAFF2 = relationship('STAFF', primaryjoin='HIERARCHY.UPDATED_BY == STAFF.ST_ID')
...
class LOCATIONBASEPERMISSION(Base):
    ...
    __table_args__ = (
        Index('UK_LOCATION_BASE_PERMISSION', 'SERVER_PATH', 'PATH_TYPE', 'SID', unique=True),
        {'schema': 'dbo'}
    )
...
class PROJECTCONTACT(Base):
    ...
    __table_args__ = (
        Index('IX_PROJECT_CONTACT_PRC_P_ID_PRC_SO_NUMBER', 'PRC_P_ID', 'PRC_SO_NUMBER'),
        {'schema': 'dbo'}
    )
...
class PROJECTFAILURERELHISTORY(Base):
    ...
    __table_args__ = (
        Index('IX_PROJECT_FAILURE_REL_HISTORY_P_ID_SO_NO', 'P_ID', 'SO_NUMBER'),
        {'schema': 'dbo'}
    )
...
t_RIGHTSMANAGEMENT_LASTRUN = Table(
    'RIGHTSMANAGEMENT_LASTRUN', metadata,
...
class RIGHTSMANAGEMENTTASK(Base):
    ...
    __table_args__ = (
        Index('IX_RIGHTSMANAGEMENT_TASK_TYPE_STATUS', 'STATUS', 'RIGHTSMANAGEMENTTASKTYPE'),
        {'schema': 'dbo'}
    )
...
class SKILLGROUP(Base):
    ...
    STAFF = relationship('STAFF', primaryjoin='SKILLGROUP.CREATED_BY == STAFF.ST_ID')
    STAFF1 = relationship('STAFF', primaryjoin='SKILLGROUP.UPDATED_BY == STAFF.ST_ID')
...
class STAFF(Base):
    ...
    __table_args__ = (
        ...
        Index('IX_STAFF_ST_ACTIVE_ST_TYPE', 'ST_ACTIVE', 'ST_TYPE', 'ST_ID', 'ST_WINDOWSID', 'ST_DOMAIN'),
        Index('UIX_STAFF_ST_DOMAIN_ST_WINDOWSID', 'ST_DOMAIN', 'ST_WINDOWSID', unique=True),
        Index('IX_STAFF_ST_TEAM', 'ST_TEAM', 'ST_ID', 'ST_SURNAME', 'ST_FORENAME', 'ST_SERVERID'),
        {'schema': 'dbo'}
    )
    ...
    SKILLGROUP = relationship('SKILLGROUP', primaryjoin='STAFF.ST_SKILLGROUP == SKILLGROUP.SG_ID')
    HIERARCHY = relationship('HIERARCHY', primaryjoin='STAFF.ST_TEAM == HIERARCHY.HR_ID')
...
class SUBORDERLAGERELEMENTHISTORY(Base):
    ...
    __table_args__ = (
        Index('IX_SUBORDER_LAGERELEMENT_HISTORY_P_ID_SO_NO', 'P_ID', 'SO_NUMBER'),
        {'schema': 'dbo'}
    )
...
class SUBORDERTESTMETHODHISTORY(Base):
    ...
    __table_args__ = (
        Index('IX_SUBORDER_TEST_METHOD_HISTORY_P_ID_SO_NO', 'P_ID', 'SO_NUMBER'),
        {'schema': 'dbo'}
    )
...
t_V_ACTION_TYPE_HISTORY = Table(
    'V_ACTION_TYPE_HISTORY', metadata,
    Column('HISTORY_ID', Integer, nullable=False),
    Column('HISTORY_TIMESTAMP', DateTime, nullable=False),
    Column('INSERTED_HIST_DB', DateTime),
    Column('IN_HIST_DB', Integer, nullable=False),
...
t_V_CALENDAR_ENTRY_HISTORY = Table(
    'V_CALENDAR_ENTRY_HISTORY', metadata,
    Column('HISTORY_ID', Integer, nullable=False),
    Column('HISTORY_TIMESTAMP', DateTime, nullable=False),
    Column('INSERTED_HIST_DB', DateTime),
    Column('IN_HIST_DB', Integer, nullable=False),
...
t_V_CERTIFICATE_CLIENT_HISTORY = Table(
    'V_CERTIFICATE_CLIENT_HISTORY', metadata,
    Column('HISTORY_ID', Integer, nullable=False),
    Column('HISTORY_TIMESTAMP', DateTime, nullable=False),
    Column('INSERTED_HIST_DB', DateTime),
    Column('IN_HIST_DB', Integer, nullable=False),
...
t_V_CERTIFICATE_HISTORY = Table(
    'V_CERTIFICATE_HISTORY', metadata,
    Column('HISTORY_ID', Integer, nullable=False),
    Column('HISTORY_TIMESTAMP', DateTime, nullable=False),
    Column('INSERTED_HIST_DB', DateTime),
    Column('IN_HIST_DB', Integer, nullable=False),
...
t_V_EDOC_TABLE_TRANSEDOC = Table(
    'V_EDOC_TABLE_TRANSEDOC', metadata,
...
t_V_EDOC_TABLE_TRANSEDOC_MODULE = Table(
    'V_EDOC_TABLE_TRANSEDOC_MODULE', metadata,
...
t_V_EDOC_TABLE_TRANSEDOC_MODULE_PHASE = Table(
    'V_EDOC_TABLE_TRANSEDOC_MODULE_PHASE', metadata,
...
t_V_EDOC_TABLE_TRANSEDOC_PHASE = Table(
    'V_EDOC_TABLE_TRANSEDOC_PHASE', metadata,
    Column('TEP_ID', Integer, nullable=False),
    Column('TE_ID', Integer, nullable=False),
...
t_V_FOCUSDOCUMENT_HISTORY = Table(
    'V_FOCUSDOCUMENT_HISTORY', metadata,
    Column('HISTORY_ID', Integer, nullable=False),
    Column('HISTORY_TIMESTAMP', DateTime, nullable=False),
    Column('INSERTED_HIST_DB', DateTime),
    Column('IN_HIST_DB', Integer, nullable=False),
...
t_V_LAGER_DEFAULT_ARCHIVLAGER = Table(
    'V_LAGER_DEFAULT_ARCHIVLAGER', metadata,
...
t_V_LAGER_DEFAULT_RUECKVERSAND = Table(
    'V_LAGER_DEFAULT_RUECKVERSAND', metadata,
...
t_V_MHS_PROJECTDATA_CODE_HISTORY = Table(
    'V_MHS_PROJECTDATA_CODE_HISTORY', metadata,
    Column('HISTORY_ID', Integer, nullable=False),
    Column('HISTORY_TIMESTAMP', DateTime, nullable=False),
    Column('INSERTED_HIST_DB', DateTime),
    Column('IN_HIST_DB', Integer, nullable=False),
...
t_V_MHS_PROJECTDATA_HISTORY = Table(
    'V_MHS_PROJECTDATA_HISTORY', metadata,
    Column('HISTORY_ID', Integer, nullable=False),
    Column('HISTORY_TIMESTAMP', DateTime, nullable=False),
    Column('INSERTED_HIST_DB', DateTime),
    Column('IN_HIST_DB', Integer, nullable=False),
...
t_V_PROCESSFOLDER_HISTORY = Table(
    'V_PROCESSFOLDER_HISTORY', metadata,
    Column('HISTORY_ID', Integer, nullable=False),
    Column('HISTORY_TIMESTAMP', DateTime, nullable=False),
    Column('INSERTED_HIST_DB', DateTime),
    Column('IN_HIST_DB', Integer, nullable=False),
...
t_V_PROCESSPORTAL_FILES_HISTORY = Table(
    'V_PROCESSPORTAL_FILES_HISTORY', metadata,
    Column('HISTORY_ID', Integer, nullable=False),
    Column('HISTORY_TIMESTAMP', DateTime, nullable=False),
    Column('INSERTED_HIST_DB', DateTime),
    Column('IN_HIST_DB', Integer, nullable=False),
...
t_V_PROCESSPORTAL_IN_HISTORY = Table(
    'V_PROCESSPORTAL_IN_HISTORY', metadata,
    Column('HISTORY_ID', Integer, nullable=False),
    Column('HISTORY_TIMESTAMP', DateTime, nullable=False),
    Column('INSERTED_HIST_DB', DateTime),
    Column('IN_HIST_DB', Integer, nullable=False),
...
t_V_PROCESS_FILES_HISTORY = Table(
    'V_PROCESS_FILES_HISTORY', metadata,
    Column('HISTORY_ID', Integer, nullable=False),
    Column('HISTORY_TIMESTAMP', DateTime, nullable=False),
    Column('INSERTED_HIST_DB', DateTime),
    Column('IN_HIST_DB', Integer, nullable=False),
...
t_V_PROJECT_ADDON_HISTORY = Table(
    'V_PROJECT_ADDON_HISTORY', metadata,
    Column('HISTORY_ID', Integer, nullable=False),
    Column('HISTORY_TIMESTAMP', DateTime, nullable=False),
    Column('INSERTED_HIST_DB', DateTime),
    Column('IN_HIST_DB', Integer, nullable=False),
...
t_V_PROJECT_ADDON_ROOMSPECIFICDATA_HISTORY = Table(
    'V_PROJECT_ADDON_ROOMSPECIFICDATA_HISTORY', metadata,
    Column('HISTORY_ID', Integer, nullable=False),
    Column('HISTORY_TIMESTAMP', DateTime, nullable=False),
    Column('INSERTED_HIST_DB', DateTime),
    Column('IN_HIST_DB', Integer, nullable=False),
...
t_V_PROJECT_APPLICATION_FORM_HISTORY = Table(
    'V_PROJECT_APPLICATION_FORM_HISTORY', metadata,
    Column('HISTORY_ID', Integer, nullable=False),
    Column('HISTORY_TIMESTAMP', DATETIME2, nullable=False),
    Column('INSERTED_HIST_DB', DATETIME2),
    Column('IN_HIST_DB', Integer, nullable=False),
...
t_V_PROJECT_CONTACT_HISTORY = Table(
    'V_PROJECT_CONTACT_HISTORY', metadata,
    Column('HISTORY_ID', Integer, nullable=False),
    Column('HISTORY_TIMESTAMP', DateTime, nullable=False),
    Column('INSERTED_HIST_DB', DateTime),
    Column('IN_HIST_DB', Integer, nullable=False),
...
t_V_PROJECT_FAILURE_REL_HISTORY = Table(
    'V_PROJECT_FAILURE_REL_HISTORY', metadata,
    Column('HISTORY_ID', Integer, nullable=False),
    Column('HISTORY_TIMESTAMP', DateTime, nullable=False),
    Column('INSERTED_HIST_DB', DateTime),
    Column('IN_HIST_DB', Integer, nullable=False),
...
t_V_PROJECT_POSITION_HISTORY = Table(
    'V_PROJECT_POSITION_HISTORY', metadata,
    Column('HISTORY_ID', Integer, nullable=False),
    Column('HISTORY_TIMESTAMP', DateTime, nullable=False),
    Column('INSERTED_HIST_DB', DateTime),
    Column('IN_HIST_DB', Integer, nullable=False),
...
t_V_PROJECT_STARLIMS_HISTORY = Table(
    'V_PROJECT_STARLIMS_HISTORY', metadata,
    Column('HISTORY_ID', Integer, nullable=False),
    Column('HISTORY_TIMESTAMP', DateTime, nullable=False),
    Column('INSERTED_HIST_DB', DateTime),
    Column('IN_HIST_DB', Integer, nullable=False),
...
t_V_PROKALKMODUL_HISTORY = Table(
    'V_PROKALKMODUL_HISTORY', metadata,
    Column('HISTORY_ID', Integer, nullable=False),
    Column('HISTORY_TIMESTAMP', DateTime, nullable=False),
    Column('INSERTED_HIST_DB', DateTime),
    Column('IN_HIST_DB', Integer, nullable=False),
...
t_V_PROKALKUNTERMODUL_HISTORY = Table(
    'V_PROKALKUNTERMODUL_HISTORY', metadata,
    Column('HISTORY_ID', Integer, nullable=False),
    Column('HISTORY_TIMESTAMP', DateTime, nullable=False),
    Column('INSERTED_HIST_DB', DateTime),
    Column('IN_HIST_DB', Integer, nullable=False),
...
t_V_SOTRANSFERFILE_HISTORY = Table(
    'V_SOTRANSFERFILE_HISTORY', metadata,
    Column('HISTORY_ID', Integer, nullable=False),
    Column('HISTORY_TIMESTAMP', DateTime, nullable=False),
    Column('INSERTED_HIST_DB', DateTime),
    Column('IN_HIST_DB', Integer, nullable=False),
...
t_V_SOTRANSFERJOB_HISTORY = Table(
    'V_SOTRANSFERJOB_HISTORY', metadata,
    Column('HISTORY_ID', Integer, nullable=False),
    Column('HISTORY_TIMESTAMP', DateTime, nullable=False),
    Column('INSERTED_HIST_DB', DateTime),
    Column('IN_HIST_DB', Integer, nullable=False),
...
t_V_STORIX_LAGERELEMENT = Table(
    'V_STORIX_LAGERELEMENT', metadata,
    Column('LGEL_ID', Integer, nullable=False),
    Column('LG_ID', Integer),
    Column('LGEL_NR', Integer),
    Column('LGEL_BEZEICHNUNG', Unicode(255)),
...
t_V_STORIX_STATUS_ERLEDIGT = Table(
    'V_STORIX_STATUS_ERLEDIGT', metadata,
...
t_V_SUBORDER_LAGERELEMENT_HISTORY = Table(
    'V_SUBORDER_LAGERELEMENT_HISTORY', metadata,
    Column('HISTORY_ID', Integer, nullable=False),
    Column('HISTORY_TIMESTAMP', DateTime, nullable=False),
    Column('INSERTED_HIST_DB', DateTime),
    Column('IN_HIST_DB', Integer, nullable=False),
...
t_V_SUBORDER_SAMPLE_HISTORY = Table(
    'V_SUBORDER_SAMPLE_HISTORY', metadata,
    Column('HISTORY_ID', Integer, nullable=False),
    Column('HISTORY_TIMESTAMP', DateTime, nullable=False),
    Column('INSERTED_HIST_DB', DateTime),
    Column('IN_HIST_DB', Integer, nullable=False),
...
t_V_SUBORDER_TEST_METHOD_HISTORY = Table(
    'V_SUBORDER_TEST_METHOD_HISTORY', metadata,
    Column('HISTORY_ID', Integer, nullable=False),
    Column('HISTORY_TIMESTAMP', DateTime, nullable=False),
    Column('INSERTED_HIST_DB', DateTime),
    Column('IN_HIST_DB', Integer, nullable=False),
...
t_V_SUBORDER_TEST_REQUIREMENT_SAMPLE_HISTORY = Table(
    'V_SUBORDER_TEST_REQUIREMENT_SAMPLE_HISTORY', metadata,
    Column('HISTORY_ID', Integer, nullable=False),
    Column('HISTORY_TIMESTAMP', DateTime, nullable=False),
    Column('INSERTED_HIST_DB', DateTime),
    Column('IN_HIST_DB', Integer, nullable=False),
...
t_V_TESTSAMPLECHARACTERISTICS_HISTORY = Table(
    'V_TESTSAMPLECHARACTERISTICS_HISTORY', metadata,
    Column('HISTORY_ID', Integer, nullable=False),
    Column('HISTORY_TIMESTAMP', DateTime, nullable=False),
    Column('INSERTED_HIST_DB', DateTime),
    Column('IN_HIST_DB', Integer, nullable=False),
...
t_V_TESTSAMPLEPICTURE_HISTORY = Table(
    'V_TESTSAMPLEPICTURE_HISTORY', metadata,
    Column('HISTORY_ID', Integer, nullable=False),
    Column('HISTORY_TIMESTAMP', DateTime, nullable=False),
    Column('INSERTED_HIST_DB', DateTime),
    Column('IN_HIST_DB', Integer, nullable=False),
...
t_V_VERIFICATION_DOCUMENT_HISTORY = Table(
    'V_VERIFICATION_DOCUMENT_HISTORY', metadata,
    Column('HISTORY_ID', Integer, nullable=False),
    Column('HISTORY_TIMESTAMP', DateTime, nullable=False),
    Column('INSERTED_HIST_DB', DateTime),
    Column('IN_HIST_DB', Integer, nullable=False),
...
t_V_WORKINGCLUSTERS_TO_ANONYMIZE = Table(
    'V_WORKINGCLUSTERS_TO_ANONYMIZE', metadata,
...
class VersionInfo(Base):
    ...
    __table_args__ = (
        Index('IX_VersionInfo_TYPE_RELEASE_SEQ_ObsoleteDate', 'TYPE', 'RELEASE_SEQ', 'ObsoleteDate', 'FullVersionPath'),
        {'schema': 'dbo'}
    )
...
class ZARAMATERIAL(Base):
    ...
    __table_args__ = (
        Index('UQ_DEFAULT_FOR_PP_TYPE', 'MD_ID', 'ZM_BOOKING_AREA', 'DEFAULT_FOR_PP_TYPE', unique=True),
        Index('IX_ZARA_MATERIAL_MD_ID_ZM_BOOKING_AREA_SERVERID', 'MD_ID', 'ZM_BOOKING_AREA', 'SERVERID', 'STATUS', 'STATUS_FROM', 'LVORM', 'ZM_ID', 'ACOT_ID', 'ZM_MATERIAL_GROUP', 'CREATED', 'UPDATED', 'POSTABLE', 'SET_INVOICINGTRAVELCOST'),
        Index('IX_ZARA_MATERIAL_MD_ID_BOOKING_AREA', 'MD_ID', 'ZM_BOOKING_AREA', 'ZM_ID', 'ACOT_ID', 'SERVERID', 'ZM_MATERIAL_GROUP', 'CREATED', 'UPDATED', 'POSTABLE', 'STATUS', 'STATUS_FROM', 'LVORM', 'STAFF_POSTABLE', 'DISABLED'),
        {'schema': 'dbo'}
    )
...
class ACCOUNTTYPE(Base):
    ...
    STAFF = relationship('STAFF', primaryjoin='ACCOUNTTYPE.CREATED_BY == STAFF.ST_ID')
    STAFF1 = relationship('STAFF', primaryjoin='ACCOUNTTYPE.UPDATED_BY == STAFF.ST_ID')
...
class ACTIONTYPE(Base):
    ...
    STAFF = relationship('STAFF', primaryjoin='ACTIONTYPE.CREATED_BY == STAFF.ST_ID')
    STAFF1 = relationship('STAFF', primaryjoin='ACTIONTYPE.UPDATED_BY == STAFF.ST_ID')


class ACTIVITYTYPE(Base):
    __tablename__ = 'ACTIVITY_TYPE'
    __table_args__ = (
        Index('UIX_ACTIVITY_TYPE_BOOKING_AREA_SKILLGROUP_DISABLED', 'BOOKING_AREA', 'SKILLGROUP', 'DISABLED', unique=True),
        {'schema': 'dbo'}
    )
    ...
    STAFF = relationship('STAFF', primaryjoin='ACTIVITYTYPE.CREATED_BY == STAFF.ST_ID')
    STAFF1 = relationship('STAFF', primaryjoin='ACTIVITYTYPE.UPDATED_BY == STAFF.ST_ID')


class ADDITIONALCOSTCENTER(Base):
    __tablename__ = 'ADDITIONAL_COST_CENTER'
    __table_args__ = (
        Index('UIX_ADDITIONAL_COST_CENTER_ORDER_COST_CENTER_ADDITIONAL_COST_CENTER', 'ORDER_COST_CENTER', 'ADDITIONAL_COST_CENTER', unique=True),
        {'schema': 'dbo'}
    )

    ID = Column(Integer, primary_key=True)
    ORDER_COST_CENTER = Column(ForeignKey('dbo.KST.CC_ID'), nullable=False)
    ADDITIONAL_COST_CENTER = Column(ForeignKey('dbo.KST.CC_ID'), nullable=False)
    DISABLED = Column(BIT, nullable=False)
    CREATED = Column(DateTime, nullable=False)
    CREATED_BY = Column(ForeignKey('dbo.STAFF.ST_ID'), nullable=False)
    UPDATED = Column(DateTime)
    ...
    KST = relationship('KST', primaryjoin='ADDITIONALCOSTCENTER.ADDITIONAL_COST_CENTER == KST.CC_ID')
    STAFF = relationship('STAFF', primaryjoin='ADDITIONALCOSTCENTER.CREATED_BY == STAFF.ST_ID')
    KST1 = relationship('KST', primaryjoin='ADDITIONALCOSTCENTER.ORDER_COST_CENTER == KST.CC_ID')
    STAFF1 = relationship('STAFF', primaryjoin='ADDITIONALCOSTCENTER.UPDATED_BY == STAFF.ST_ID')
...
class APPLICATIONFORM(Base):
    ...
    STAFF = relationship('STAFF', primaryjoin='APPLICATIONFORM.CREATED_BY == STAFF.ST_ID')
    STAFF1 = relationship('STAFF', primaryjoin='APPLICATIONFORM.UPDATED_BY == STAFF.ST_ID')
...
class CALCULATIONAREA(Base):
    ...
    WORKING_CLUSTER = Column(ForeignKey('dbo.HIERARCHY.HR_ID'), primary_key=True, nullable=False)
    ...
    STAFF = relationship('STAFF', primaryjoin='CALCULATIONAREA.CA_CREATED_BY == STAFF.ST_ID')
    STAFF1 = relationship('STAFF', primaryjoin='CALCULATIONAREA.CA_UPDATED_BY == STAFF.ST_ID')
...
class CANCELLATIONREASON(Base):
    ...
    STAFF = relationship('STAFF', primaryjoin='CANCELLATIONREASON.CREATED_BY == STAFF.ST_ID')
    STAFF1 = relationship('STAFF', primaryjoin='CANCELLATIONREASON.UPDATED_BY == STAFF.ST_ID')
...
class CATEGORY(Base):
    ...
    STAFF = relationship('STAFF', primaryjoin='CATEGORY.CREATED_BY == STAFF.ST_ID')
    parent = relationship('CATEGORY', remote_side=[ID])
    STAFF1 = relationship('STAFF', primaryjoin='CATEGORY.UPDATED_BY == STAFF.ST_ID')
...
class CERTAPPLTC(Base):
    ...
    STAFF = relationship('STAFF', primaryjoin='CERTAPPLTC.CREATEBY == STAFF.ST_ID')
    STAFF1 = relationship('STAFF', primaryjoin='CERTAPPLTC.UPDATEBY == STAFF.ST_ID')
...
class CHANCETYPE(Base):
    ...
    STAFF = relationship('STAFF', primaryjoin='CHANCETYPE.CREATED_BY == STAFF.ST_ID')
    STAFF1 = relationship('STAFF', primaryjoin='CHANCETYPE.UPDATED_BY == STAFF.ST_ID')
...
class CHECKVIEWMD(Base):
    ...
    STAFF = relationship('STAFF', primaryjoin='CHECKVIEWMD.CREATED_BY == STAFF.ST_ID')
    STAFF1 = relationship('STAFF', primaryjoin='CHECKVIEWMD.UPDATED_BY == STAFF.ST_ID')
...
class CONTRACTTYPE(Base):
    ...
    STAFF = relationship('STAFF', primaryjoin='CONTRACTTYPE.CREATED_BY == STAFF.ST_ID')
    STAFF1 = relationship('STAFF', primaryjoin='CONTRACTTYPE.UPDATED_BY == STAFF.ST_ID')
...
class CONTRACTTYPEDEFAULT(Base):
    ...
    STAFF = relationship('STAFF', primaryjoin='CONTRACTTYPEDEFAULT.CREATED_BY == STAFF.ST_ID')
    STAFF1 = relationship('STAFF', primaryjoin='CONTRACTTYPEDEFAULT.UPDATED_BY == STAFF.ST_ID')
...
class CURRENCY(Base):
    ...
    STAFF = relationship('STAFF', primaryjoin='CURRENCY.CREATED_BY == STAFF.ST_ID')
    STAFF1 = relationship('STAFF', primaryjoin='CURRENCY.UPDATED_BY == STAFF.ST_ID')


class CUSTOMER(Base):
    __tablename__ = 'CUSTOMER'
    __table_args__ = (
        Index('IX_CUSTOMER_MD_ID_CU_ACTIVE_CU_ID', 'MD_ID', 'CU_ACTIVE', 'CU_ID', 'CU_NUMBER', 'CU_LOCKED', 'CU_BOOKING_AREA', 'CU_SERVERID', 'CU_LANGUAGE', 'CU_USER_STATE'),
        Index('IX_CUSTOMER_MD_ID_CU_ACTIVE_CU_KTOKD_CU_ID_CU_NUMBER', 'MD_ID', 'CU_ACTIVE', 'CU_KTOKD', 'CU_ID', 'CU_NUMBER', 'CU_LOCKED', 'CU_SERVERID', 'CU_LANGUAGE', 'CU_USER_STATE'),
        Index('IX_CUSTOMER_MDO_NUMBER_CU_NUMBER', 'MDO_NUMBER', 'CU_NUMBER'),
        Index('IX_CUSTOMER_CU_BOOKING_AREA_CU_MARK', 'CU_BOOKING_AREA', 'CU_MARK', 'CU_ID', 'CU_NUMBER'),
        {'schema': 'dbo'}
    )
    ...
    STAFF = relationship('STAFF', primaryjoin='CUSTOMER.CREATED_BY == STAFF.ST_ID')
    MANDATOR = relationship('MANDATOR')
    STAFF1 = relationship('STAFF', primaryjoin='CUSTOMER.UPDATED_BY == STAFF.ST_ID')
...
class CUSTOMERCONTACTFUNCTION(Base):
    ...
    STAFF = relationship('STAFF', primaryjoin='CUSTOMERCONTACTFUNCTION.CCF_CREATEDBY == STAFF.ST_ID')
    STAFF1 = relationship('STAFF', primaryjoin='CUSTOMERCONTACTFUNCTION.CCF_UPDATEDBY == STAFF.ST_ID')
...
class CUSTOMERREGION(Base):
    ...
    STAFF = relationship('STAFF', primaryjoin='CUSTOMERREGION.CREATED_BY == STAFF.ST_ID')
    STAFF1 = relationship('STAFF', primaryjoin='CUSTOMERREGION.UPDATED_BY == STAFF.ST_ID')
...
class DEADLINEDEFAULT(Base):
    ...
    STAFF = relationship('STAFF', primaryjoin='DEADLINEDEFAULT.CREATED_BY == STAFF.ST_ID')
    STAFF1 = relationship('STAFF', primaryjoin='DEADLINEDEFAULT.UPDATED_BY == STAFF.ST_ID')
...
class DELAYREASON(Base):
    ...
    STAFF = relationship('STAFF', primaryjoin='DELAYREASON.CREATED_BY == STAFF.ST_ID')
    STAFF1 = relationship('STAFF', primaryjoin='DELAYREASON.UPDATED_BY == STAFF.ST_ID')
...
class DEVICETYPE(Base):
    ...
    STAFF = relationship('STAFF', primaryjoin='DEVICETYPE.CREATED_BY == STAFF.ST_ID')
    STAFF1 = relationship('STAFF', primaryjoin='DEVICETYPE.UPDATED_BY == STAFF.ST_ID')
...
class DIRECTORY(Base):
    ...
    STAFF = relationship('STAFF', primaryjoin='DIRECTORY.CREATED_BY == STAFF.ST_ID')
    MANDATOR = relationship('MANDATOR')
    STAFF1 = relationship('STAFF', primaryjoin='DIRECTORY.UPDATED_BY == STAFF.ST_ID')
    HIERARCHY = relationship('HIERARCHY')
...
class DISPODATASECTIONRULE(Base):
    ...
    CUSTOMER = Column(ForeignKey('dbo.DISPO_KNOWN_CUSTOMERS.ID'), primary_key=True, nullable=False)
    TEST_TYPE = Column(Unicode(100), nullable=False)
    RULE = Column(Unicode(4000), nullable=False)
    OPTIONS = Column(Unicode(4000))
    CREATED = Column(DateTime, nullable=False)
...
class DOCTYPE(Base):
    ...
    STAFF = relationship('STAFF', primaryjoin='DOCTYPE.CREATED_BY == STAFF.ST_ID')
    STAFF1 = relationship('STAFF', primaryjoin='DOCTYPE.UPDATED_BY == STAFF.ST_ID')
...
class EMAILSUBJECT(Base):
    ...
    STAFF = relationship('STAFF', primaryjoin='EMAILSUBJECT.CREATED_BY == STAFF.ST_ID')
    HIERARCHY = relationship('HIERARCHY')
    MANDATOR = relationship('MANDATOR')
    STAFF1 = relationship('STAFF', primaryjoin='EMAILSUBJECT.UPDATED_BY == STAFF.ST_ID')
...
class ERRORCOMMENT(Base):
    ...
    STAFF = relationship('STAFF', primaryjoin='ERRORCOMMENT.CREATED_BY == STAFF.ST_ID')
    STAFF1 = relationship('STAFF', primaryjoin='ERRORCOMMENT.UPDATED_BY == STAFF.ST_ID')
...
class FILEFORMATREGISTER(Base):
    ...
    STAFF = relationship('STAFF', primaryjoin='FILEFORMATREGISTER.CREATED_BY == STAFF.ST_ID')
    STAFF1 = relationship('STAFF', primaryjoin='FILEFORMATREGISTER.UPDATED_BY == STAFF.ST_ID')
...
class GMAENTRY(Base):
    ...
    STAFF = relationship('STAFF', primaryjoin='GMAENTRY.CREATED_BY == STAFF.ST_ID')
    STAFF1 = relationship('STAFF', primaryjoin='GMAENTRY.UPDATED_BY == STAFF.ST_ID')
...
class HIERARCHYOPTION(Base):
    ...
    __table_args__ = (
        Index('UIX_HIERARCHY_OPTION_HR_ID_OPTION_KEY_DISABLED', 'HR_ID', 'OPTION_KEY', 'DISABLED', unique=True),
        {'schema': 'dbo'}
    )
...
class HOLIDAY(Base):
    ...
    __table_args__ = (
        Index('UIX_HOLIDAY_H_HOLIDAYDATE_H_DISABLED_HR_ID', 'H_HOLIDAYDATE', 'HR_ID', unique=True),
        {'schema': 'dbo'}
    )
    ...
    STAFF = relationship('STAFF', primaryjoin='HOLIDAY.CREATED_BY == STAFF.ST_ID')
    STAFF1 = relationship('STAFF', primaryjoin='HOLIDAY.UPDATED_BY == STAFF.ST_ID')
...
class ICTRANSACTION(Base):
    ...
    STAFF = relationship('STAFF', primaryjoin='ICTRANSACTION.CREATED_BY == STAFF.ST_ID')
    STAFF1 = relationship('STAFF', primaryjoin='ICTRANSACTION.UPDATED_BY == STAFF.ST_ID')
...
class INSPECTIONCYCLE(Base):
    ...
    STAFF = relationship('STAFF', primaryjoin='INSPECTIONCYCLE.CREATED_BY == STAFF.ST_ID')
    STAFF1 = relationship('STAFF', primaryjoin='INSPECTIONCYCLE.UPDATED_BY == STAFF.ST_ID')
...
class INTERNALNOTE(Base):
    ...
    STAFF = relationship('STAFF', primaryjoin='INTERNALNOTE.CREATED_BY == STAFF.ST_ID')
    STAFF1 = relationship('STAFF', primaryjoin='INTERNALNOTE.UPDATED_BY == STAFF.ST_ID')
...
class KINDOFBILL(Base):
    ...
    STAFF = relationship('STAFF', primaryjoin='KINDOFBILL.CREATED_BY == STAFF.ST_ID')
    STAFF1 = relationship('STAFF', primaryjoin='KINDOFBILL.UPDATED_BY == STAFF.ST_ID')
...
class KINDOFPRODUCT(Base):
    ...
    STAFF = relationship('STAFF', primaryjoin='KINDOFPRODUCT.CREATED_BY == STAFF.ST_ID')
    STAFF1 = relationship('STAFF', primaryjoin='KINDOFPRODUCT.UPDATED_BY == STAFF.ST_ID')
...
class KINDOFTEST(Base):
    ...
    STAFF = relationship('STAFF', primaryjoin='KINDOFTEST.CREATED_BY == STAFF.ST_ID')
    STAFF1 = relationship('STAFF', primaryjoin='KINDOFTEST.UPDATED_BY == STAFF.ST_ID')
    HIERARCHY = relationship('HIERARCHY')
...
class LIDLQAMEMBER(Base):
    ...
    STAFF = relationship('STAFF', primaryjoin='LIDLQAMEMBER.CREATED_BY == STAFF.ST_ID')
    STAFF1 = relationship('STAFF', primaryjoin='LIDLQAMEMBER.UPDATED_BY == STAFF.ST_ID')
...
class LIMSSTANDARDANALYSI(Base):
    ...
    TEST_METHOD_ID = Column(ForeignKey('dbo.LIMS_TEST_METHOD.ID'), nullable=False)
    DISABLED = Column(BIT, nullable=False)
    CREATED = Column(DateTime, nullable=False)
    UPDATED = Column(DateTime)
...
class LOCATIONSERVER(Base):
    ...
    HR_ID = Column(ForeignKey('dbo.HIERARCHY.HR_ID'), nullable=False, unique=True)
    MD_ID = Column(ForeignKey('dbo.MANDATOR.ID'), nullable=False)
    ...
    STAFF = relationship('STAFF', primaryjoin='LOCATIONSERVER.CREATED_BY == STAFF.ST_ID')
    HIERARCHY = relationship('HIERARCHY')
    LANGUAGE_TYPE = relationship('LANGUAGETYPE')
    MANDATOR = relationship('MANDATOR')
    STAFF1 = relationship('STAFF', primaryjoin='LOCATIONSERVER.UPDATED_BY == STAFF.ST_ID')
...
class MAINGRIDINIT(Base):
    ...
    WC_ID = Column(ForeignKey('dbo.HIERARCHY.HR_ID'), primary_key=True, nullable=False)
    ...
    STAFF = relationship('STAFF', primaryjoin='MAINGRIDINIT.CREATED_BY == STAFF.ST_ID')
    STAFF1 = relationship('STAFF', primaryjoin='MAINGRIDINIT.UPDATED_BY == STAFF.ST_ID')
    HIERARCHY = relationship('HIERARCHY')
...
class OBJECTCATEGORYMD(Base):
    ...
    STAFF = relationship('STAFF', primaryjoin='OBJECTCATEGORYMD.CREATED_BY == STAFF.ST_ID')
    STAFF1 = relationship('STAFF', primaryjoin='OBJECTCATEGORYMD.UPDATED_BY == STAFF.ST_ID')
...
class PERIODFILTER(Base):
    ...
    STAFF = relationship('STAFF', primaryjoin='PERIODFILTER.CREATED_BY == STAFF.ST_ID')
    STAFF1 = relationship('STAFF', primaryjoin='PERIODFILTER.UPDATED_BY == STAFF.ST_ID')
...
class PERMISSION(Base):
    ...
    STAFF = relationship('STAFF', primaryjoin='PERMISSION.CREATED_BY == STAFF.ST_ID')
    STAFF1 = relationship('STAFF', primaryjoin='PERMISSION.UPDATED_BY == STAFF.ST_ID')
...
class PLANT(Base):
    ...
    STAFF = relationship('STAFF', primaryjoin='PLANT.CREATED_BY == STAFF.ST_ID')
    STAFF1 = relationship('STAFF', primaryjoin='PLANT.UPDATED_BY == STAFF.ST_ID')
...
class PORTAL(Base):
    ...
    STAFF = relationship('STAFF', primaryjoin='PORTAL.CREATED_BY == STAFF.ST_ID')
    parent = relationship('PORTAL', remote_side=[ID])
    STAFF1 = relationship('STAFF', primaryjoin='PORTAL.UPDATED_BY == STAFF.ST_ID')
...
class PORTALCUSTOMER(Base):
    ...
    STAFF = relationship('STAFF', primaryjoin='PORTALCUSTOMER.CREATED_BY == STAFF.ST_ID')
    STAFF1 = relationship('STAFF', primaryjoin='PORTALCUSTOMER.UPDATED_BY == STAFF.ST_ID')
...
class PRESSUREUNITMD(Base):
    ...
    STAFF = relationship('STAFF', primaryjoin='PRESSUREUNITMD.CREATED_BY == STAFF.ST_ID')
    STAFF1 = relationship('STAFF', primaryjoin='PRESSUREUNITMD.UPDATED_BY == STAFF.ST_ID')
...
class PRICELIST(Base):
    ...
    STAFF = relationship('STAFF', primaryjoin='PRICELIST.CREATED_BY == STAFF.ST_ID')
    STAFF1 = relationship('STAFF', primaryjoin='PRICELIST.UPDATED_BY == STAFF.ST_ID')
...
class PROCESSFOLDER(Base):
    ...
    HIERARCHY = relationship('HIERARCHY', primaryjoin='PROCESSFOLDER.PCF_CHECKOUTBY_TEAM == HIERARCHY.HR_NEW_ID')
    HIERARCHY1 = relationship('HIERARCHY', primaryjoin='PROCESSFOLDER.PCF_REGBY_TEAM == HIERARCHY.HR_NEW_ID')
    HIERARCHY2 = relationship('HIERARCHY', primaryjoin='PROCESSFOLDER.PCF_UPDATEBY_TEAM == HIERARCHY.HR_NEW_ID')
...
class PROCESSPHASE(Base):
    ...
    STAFF = relationship('STAFF', primaryjoin='PROCESSPHASE.CREATED_BY == STAFF.ST_ID')
    STAFF1 = relationship('STAFF', primaryjoin='PROCESSPHASE.UPDATED_BY == STAFF.ST_ID')
...
class PROCESSSTATU(Base):
    ...
    STAFF = relationship('STAFF', primaryjoin='PROCESSSTATU.CREATED_BY == STAFF.ST_ID')
    STAFF1 = relationship('STAFF', primaryjoin='PROCESSSTATU.UPDATED_BY == STAFF.ST_ID')
...
class PRODUCTGROUPMD(Base):
    ...
    STAFF = relationship('STAFF', primaryjoin='PRODUCTGROUPMD.CREATED_BY == STAFF.ST_ID')
    STAFF1 = relationship('STAFF', primaryjoin='PRODUCTGROUPMD.UPDATED_BY == STAFF.ST_ID')
...
class PROJECTCATEGORYMD(Base):
    ...
    STAFF = relationship('STAFF', primaryjoin='PROJECTCATEGORYMD.CREATED_BY == STAFF.ST_ID')
    STAFF1 = relationship('STAFF', primaryjoin='PROJECTCATEGORYMD.UPDATED_BY == STAFF.ST_ID')
...
class PROJECTFLUIDGROUPMD(Base):
    ...
    STAFF = relationship('STAFF', primaryjoin='PROJECTFLUIDGROUPMD.CREATED_BY == STAFF.ST_ID')
    STAFF1 = relationship('STAFF', primaryjoin='PROJECTFLUIDGROUPMD.UPDATED_BY == STAFF.ST_ID')
...
class PROJECTMODULEMD(Base):
    ...
    STAFF = relationship('STAFF', primaryjoin='PROJECTMODULEMD.CREATED_BY == STAFF.ST_ID')
    STAFF1 = relationship('STAFF', primaryjoin='PROJECTMODULEMD.UPDATED_BY == STAFF.ST_ID')
...
class PROJECTPERIODFILTER(Base):
    ...
    STAFF = relationship('STAFF', primaryjoin='PROJECTPERIODFILTER.CREATED_BY == STAFF.ST_ID')
    STAFF1 = relationship('STAFF', primaryjoin='PROJECTPERIODFILTER.UPDATED_BY == STAFF.ST_ID')
...
class PSEXCREDENTIAL(Base):
    ...
    STAFF = relationship('STAFF', primaryjoin='PSEXCREDENTIAL.CREATED_BY == STAFF.ST_ID')
    STAFF1 = relationship('STAFF', primaryjoin='PSEXCREDENTIAL.UPDATED_BY == STAFF.ST_ID')
...
class REASONFORADDITIONALEFFORT(Base):
    ...
    STAFF = relationship('STAFF', primaryjoin='REASONFORADDITIONALEFFORT.CREATED_BY == STAFF.ST_ID')
    STAFF1 = relationship('STAFF', primaryjoin='REASONFORADDITIONALEFFORT.UPDATED_BY == STAFF.ST_ID')
...
class RECOMMENDEDORDERTEXT(Base):
    ...
    MD_ID = Column(ForeignKey('dbo.MANDATOR.ID'), primary_key=True, nullable=False)
    ...
    STAFF = relationship('STAFF', primaryjoin='RECOMMENDEDORDERTEXT.CREATED_BY == STAFF.ST_ID')
    MANDATOR = relationship('MANDATOR')
    STAFF1 = relationship('STAFF', primaryjoin='RECOMMENDEDORDERTEXT.UPDATED_BY == STAFF.ST_ID')
...
class RELEASEMETHOD(Base):
    ...
    STAFF = relationship('STAFF', primaryjoin='RELEASEMETHOD.CREATED_BY == STAFF.ST_ID')
    STAFF1 = relationship('STAFF', primaryjoin='RELEASEMETHOD.UPDATED_BY == STAFF.ST_ID')
...
class REPORTRELEVANTTESTBASISMD(Base):
    ...
    STAFF = relationship('STAFF', primaryjoin='REPORTRELEVANTTESTBASISMD.CREATED_BY == STAFF.ST_ID')
    STAFF1 = relationship('STAFF', primaryjoin='REPORTRELEVANTTESTBASISMD.UPDATED_BY == STAFF.ST_ID')
...
class RETURNADDRES(Base):
    ...
    STAFF = relationship('STAFF', primaryjoin='RETURNADDRES.CREATED_BY == STAFF.ST_ID')
    STAFF1 = relationship('STAFF', primaryjoin='RETURNADDRES.UPDATED_BY == STAFF.ST_ID')
    HIERARCHY = relationship('HIERARCHY')
...
class ROOMDESIGNATIONMD(Base):
    ...
    STAFF = relationship('STAFF', primaryjoin='ROOMDESIGNATIONMD.CREATED_BY == STAFF.ST_ID')
    STAFF1 = relationship('STAFF', primaryjoin='ROOMDESIGNATIONMD.UPDATED_BY == STAFF.ST_ID')
...
class SEARCHLEVEL(Base):
    ...
    STAFF = relationship('STAFF', primaryjoin='SEARCHLEVEL.CREATED_BY == STAFF.ST_ID')
    HIERARCHY = relationship('HIERARCHY')
    STAFF1 = relationship('STAFF', primaryjoin='SEARCHLEVEL.ST_ID == STAFF.ST_ID')
    STAFF2 = relationship('STAFF', primaryjoin='SEARCHLEVEL.UPDATED_BY == STAFF.ST_ID')
...
class SPECIALTYPE(Base):
    ...
    STAFF = relationship('STAFF', primaryjoin='SPECIALTYPE.CREATED_BY == STAFF.ST_ID')
    STAFF1 = relationship('STAFF', primaryjoin='SPECIALTYPE.UPDATED_BY == STAFF.ST_ID')
...
class STAFFHIERARCHY(Base):
    ...
    STAFF = relationship('STAFF', primaryjoin='STAFFHIERARCHY.CREATED_BY == STAFF.ST_ID')
    HIERARCHY = relationship('HIERARCHY')
    STAFF1 = relationship('STAFF', primaryjoin='STAFFHIERARCHY.ST_ID == STAFF.ST_ID')
    STAFF2 = relationship('STAFF', primaryjoin='STAFFHIERARCHY.UPDATED_BY == STAFF.ST_ID')
...
class STAFFROLE(Base):
    ...
    STAFF = relationship('STAFF', primaryjoin='STAFFROLE.CREATED_BY == STAFF.ST_ID')
    ROLE = relationship('ROLE')
    STAFF1 = relationship('STAFF', primaryjoin='STAFFROLE.ST_ID == STAFF.ST_ID')
    STAFF2 = relationship('STAFF', primaryjoin='STAFFROLE.UPDATED_BY == STAFF.ST_ID')
...
class STAFFFAVORITE(Base):
    ...
    STAFF = relationship('STAFF', primaryjoin='STAFFFAVORITE.CREATED_BY == STAFF.ST_ID')
    STAFF1 = relationship('STAFF', primaryjoin='STAFFFAVORITE.STAFF_FAV_ID == STAFF.ST_ID')
    STAFF2 = relationship('STAFF', primaryjoin='STAFFFAVORITE.STAFF_ID == STAFF.ST_ID')
    STAFF3 = relationship('STAFF', primaryjoin='STAFFFAVORITE.UPDATED_BY == STAFF.ST_ID')
...
class STAFFSETTING(Base):
    ...
    STAFF = relationship('STAFF', primaryjoin='STAFFSETTING.CREATED_BY == STAFF.ST_ID')
    STAFF1 = relationship('STAFF', primaryjoin='STAFFSETTING.UPDATED_BY == STAFF.ST_ID')
...
class STATEOFAGGREGATIONMD(Base):
    ...
    STAFF = relationship('STAFF', primaryjoin='STATEOFAGGREGATIONMD.CREATED_BY == STAFF.ST_ID')
    STAFF1 = relationship('STAFF', primaryjoin='STATEOFAGGREGATIONMD.UPDATED_BY == STAFF.ST_ID')
...
class SUBORDERCATEGORY(Base):
    ...
    STAFF = relationship('STAFF', primaryjoin='SUBORDERCATEGORY.CREATED_BY == STAFF.ST_ID')
    STAFF1 = relationship('STAFF', primaryjoin='SUBORDERCATEGORY.UPDATED_BY == STAFF.ST_ID')


class SURVEYORDERSIZE(Base):
    __tablename__ = 'SURVEY_ORDER_SIZE'
    __table_args__ = (
        Index('IX_SURVEY_ORDER_SIZE_HR_ID_VALID_FROM_VALID_UNTIL', 'HR_ID', 'VALID_FROM', 'VALID_UNTIL', 'ORDER_SIZE'),
        {'schema': 'dbo'}
    )
    ...
    STAFF = relationship('STAFF', primaryjoin='SURVEYORDERSIZE.CREATED_BY == STAFF.ST_ID')
    HIERARCHY = relationship('HIERARCHY')
    STAFF1 = relationship('STAFF', primaryjoin='SURVEYORDERSIZE.UPDATED_BY == STAFF.ST_ID')
...
class TASKTABLEMAP(Base):
    ...
    TASK_ELEMENT = relationship('TASKELEMENT', primaryjoin='TASKTABLEMAP.ELEMENT_ID == TASKELEMENT.ID')
    TASK_ELEMENT1 = relationship('TASKELEMENT', primaryjoin='TASKTABLEMAP.PARENT_ID == TASKELEMENT.ID')


class TEAMRIGHTSMANAGEMENTTASKDATUM(Base):
    __tablename__ = 'TEAMRIGHTSMANAGEMENT_TASK_DATA'
    __table_args__ = (
        Index('IX_TEAMRIGHTSMANAGEMENT_TASK_DATA', 'RIGHTSMANAGEMENTTASK', 'TEAM'),
        {'schema': 'dbo'}
    )

    ID = Column(BigInteger, primary_key=True)
    RIGHTSMANAGEMENTTASK = Column(ForeignKey('dbo.RIGHTSMANAGEMENT_TASK.ID'), nullable=False)
...
class TEMPLATEFORMAT(Base):
    ...
    STAFF = relationship('STAFF', primaryjoin='TEMPLATEFORMAT.CREATED_BY == STAFF.ST_ID')
    STAFF1 = relationship('STAFF', primaryjoin='TEMPLATEFORMAT.UPDATED_BY == STAFF.ST_ID')
...
class TEMPLATESCOPE(Base):
    ...
    STAFF = relationship('STAFF', primaryjoin='TEMPLATESCOPE.CREATED_BY == STAFF.ST_ID')
    STAFF1 = relationship('STAFF', primaryjoin='TEMPLATESCOPE.UPDATED_BY == STAFF.ST_ID')
...
class TEMPLATESTATU(Base):
    ...
    STAFF = relationship('STAFF', primaryjoin='TEMPLATESTATU.CREATED_BY == STAFF.ST_ID')
    STAFF1 = relationship('STAFF', primaryjoin='TEMPLATESTATU.UPDATED_BY == STAFF.ST_ID')
...
class TEMPLATETYPE(Base):
    ...
    STAFF = relationship('STAFF', primaryjoin='TEMPLATETYPE.CREATED_BY == STAFF.ST_ID')
    STAFF1 = relationship('STAFF', primaryjoin='TEMPLATETYPE.UPDATED_BY == STAFF.ST_ID')
...
class TESTSAMPLE(Base):
    ...
    ANONYMIZATION_LOG = relationship('ANONYMIZATIONLOG')
    HIERARCHY = relationship('HIERARCHY', primaryjoin='TESTSAMPLE.TS_CREATEDBY_TEAM == HIERARCHY.HR_NEW_ID')
    HIERARCHY1 = relationship('HIERARCHY', primaryjoin='TESTSAMPLE.TS_UPDATEBY_TEAM == HIERARCHY.HR_NEW_ID')
...
class TESTSAMPLEPICTUREDESCRIPTION(Base):
    ...
    STAFF = relationship('STAFF', primaryjoin='TESTSAMPLEPICTUREDESCRIPTION.CREATED_BY == STAFF.ST_ID')
    STAFF1 = relationship('STAFF', primaryjoin='TESTSAMPLEPICTUREDESCRIPTION.UPDATED_BY == STAFF.ST_ID')
...
class TYPEOFFILE(Base):
    ...
    STAFF = relationship('STAFF', primaryjoin='TYPEOFFILE.CREATED_BY == STAFF.ST_ID')
    STAFF1 = relationship('STAFF', primaryjoin='TYPEOFFILE.UPDATED_BY == STAFF.ST_ID')


class VERSIONINFO(Base):
    __tablename__ = 'VERSION_INFO'
    __table_args__ = (
        Index('UQ_VERSION_INFO_MD_ID_VERSION_NUMBER', 'MD_ID', 'VERSION_NUMBER', unique=True),
    ...
    STAFF = relationship('STAFF', primaryjoin='VERSIONINFO.CREATED_BY == STAFF.ST_ID')
    MANDATOR = relationship('MANDATOR')
    STAFF1 = relationship('STAFF', primaryjoin='VERSIONINFO.UPDATED_BY == STAFF.ST_ID')
...
class WORKFLOWMESSAGE(Base):
    ...
    STAFF = relationship('STAFF', primaryjoin='WORKFLOWMESSAGE.WM_CREATED_BY == STAFF.ST_ID')
    STAFF1 = relationship('STAFF', primaryjoin='WORKFLOWMESSAGE.WM_UPDATED_BY == STAFF.ST_ID')


class ZARAMATERIALCONDITION(Base):
    __tablename__ = 'ZARA_MATERIAL_CONDITIONS'
    __table_args__ = (
        ForeignKeyConstraint(['ZM_ID', 'ZARA_BOOKING_AREA', 'SERVERID'], ['dbo.ZARA_MATERIAL.ZM_ID', 'dbo.ZARA_MATERIAL.ZM_BOOKING_AREA', 'dbo.ZARA_MATERIAL.SERVERID']),
        Index('IX_ZARA_MATERIAL_CONDITIONS_ZM_ID_SERVERID_BOOKINGAREA', 'SERVERID', 'ZARA_BOOKING_AREA', 'ZM_ID', 'ZMC_RATE', 'ZMC_UNIT', 'ZMC_FROM', 'ZMC_UNTIL'),
        {'schema': 'dbo'}
    )
    ...
    ZARA_BOOKING_AREA = Column(Unicode(4), primary_key=True, nullable=False, index=True)
...
class ZARAMATERIALTEXT(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(['ZM_ID', 'ZARA_BOOKING_AREA', 'SERVERID'], ['dbo.ZARA_MATERIAL.ZM_ID', 'dbo.ZARA_MATERIAL.ZM_BOOKING_AREA', 'dbo.ZARA_MATERIAL.SERVERID']),
        Index('IX_ZARA_MATERIAL_TEXT_SERVERID_BOOKING_AREA', 'SERVERID', 'ZARA_BOOKING_AREA', 'ZMT_LANGUAGE', 'ZMT_TEXT'),
        {'schema': 'dbo'}
    )
...
class ZARAMATERIALUNIT(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(['ZM_ID', 'ZARA_BOOKING_AREA', 'SERVERID'], ['dbo.ZARA_MATERIAL.ZM_ID', 'dbo.ZARA_MATERIAL.ZM_BOOKING_AREA', 'dbo.ZARA_MATERIAL.SERVERID']),
        Index('IX_ZARA_MATERIAL_UNITS_SERVERID', 'SERVERID', 'ZM_ID', 'ZMU_UNIT', 'ZMU_IS_DEFAULT', 'ZARA_BOOKING_AREA', 'CREATED', 'UPDATED'),
        Index('IX_ZARA_MATERIAL_UNITS_SERVERID_BOOKING_AREA', 'SERVERID', 'ZARA_BOOKING_AREA'),
        {'schema': 'dbo'}
    )
...
class ZARAMATERIALVTEXT(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(['ZM_ID', 'BOOKING_AREA', 'SERVERID'], ['dbo.ZARA_MATERIAL.ZM_ID', 'dbo.ZARA_MATERIAL.ZM_BOOKING_AREA', 'dbo.ZARA_MATERIAL.SERVERID']),
        {'schema': 'dbo'}
    )
...
class ZLOCATION(Base):
    ...
    STAFF = relationship('STAFF', primaryjoin='ZLOCATION.CREATED_BY == STAFF.ST_ID')
    STAFF1 = relationship('STAFF', primaryjoin='ZLOCATION.UPDATED_BY == STAFF.ST_ID')
...
class ZOBJECT(Base):
    ...
    STAFF = relationship('STAFF', primaryjoin='ZOBJECT.CREATED_BY == STAFF.ST_ID')
    STAFF1 = relationship('STAFF', primaryjoin='ZOBJECT.UPDATED_BY == STAFF.ST_ID')
...
class ZPRODUCT(Base):
    ...
    STAFF = relationship('STAFF', primaryjoin='ZPRODUCT.CREATED_BY == STAFF.ST_ID')
    STAFF1 = relationship('STAFF', primaryjoin='ZPRODUCT.UPDATED_BY == STAFF.ST_ID')
...
class ZPSBEGRIFFBEZ(Base):
    ...
    BEBE_BEGR_ID = Column(ForeignKey('dbo.ZPS_BEGRIFF.BEGR_ID'), primary_key=True, nullable=False)
...
class ZPSZERTIFIZIERGEBIET(Base):
    ...
    STAFF = relationship('STAFF', primaryjoin='ZPSZERTIFIZIERGEBIET.CREATED_BY == STAFF.ST_ID')
    STAFF1 = relationship('STAFF', primaryjoin='ZPSZERTIFIZIERGEBIET.UPDATED_BY == STAFF.ST_ID')
...
class ZSUBLOCATION(Base):
    ...
    ZM_SUBLOCATION_LANGUAGE = Column(NCHAR(2), primary_key=True, nullable=False)
    CREATED = Column(DateTime, nullable=False)
    CREATED_BY = Column(ForeignKey('dbo.STAFF.ST_ID'), nullable=False)
    UPDATED = Column(DateTime)
    UPDATED_BY = Column(ForeignKey('dbo.STAFF.ST_ID'))

    STAFF = relationship('STAFF', primaryjoin='ZSUBLOCATION.CREATED_BY == STAFF.ST_ID')
    STAFF1 = relationship('STAFF', primaryjoin='ZSUBLOCATION.UPDATED_BY == STAFF.ST_ID')


class ZVANGEBOTPOSITION(Base):
    __tablename__ = 'ZVANGEBOT_POSITION'
    __table_args__ = (
        ForeignKeyConstraint(['VBELN', 'MD_ID', 'SERVERID'], ['dbo.ZVANGEBOT.VBELN', 'dbo.ZVANGEBOT.MD_ID', 'dbo.ZVANGEBOT.SERVERID']),
        {'schema': 'dbo'}
    )
...
class ZVAUFTRAGKOPF(Base):
    ...
    VBELN = Column(Unicode(10), primary_key=True, nullable=False)
    MD_ID = Column(ForeignKey('dbo.MANDATOR.ID'), primary_key=True, nullable=False, index=True)
...
class ZVVERTRIEBSWEG(Base):
    ...
    STAFF = relationship('STAFF', primaryjoin='ZVVERTRIEBSWEG.CREATED_BY == STAFF.ST_ID')
    STAFF1 = relationship('STAFF', primaryjoin='ZVVERTRIEBSWEG.UPDATED_BY == STAFF.ST_ID')
...
class ACTIONTYPEHIERARCHY(Base):
    ...
    ID = Column(Integer, primary_key=True)
    ACTION_TYPE_ID = Column(ForeignKey('dbo.ACTION_TYPE.ACTT_ID'), nullable=False)
    HR_ID = Column(ForeignKey('dbo.HIERARCHY.HR_ID'), nullable=False)
    DISABLED = Column(DateTime)
    CREATED = Column(DateTime, nullable=False)
    CREATED_BY = Column(ForeignKey('dbo.STAFF.ST_ID'), nullable=False)
    ...
    STAFF = relationship('STAFF', primaryjoin='ACTIONTYPEHIERARCHY.CREATED_BY == STAFF.ST_ID')
    HIERARCHY = relationship('HIERARCHY')
    STAFF1 = relationship('STAFF', primaryjoin='ACTIONTYPEHIERARCHY.UPDATED_BY == STAFF.ST_ID')


class CALCULATIONAREADEPARTMENT(Base):
    __tablename__ = 'CALCULATION_AREA_DEPARTMENT'
    __table_args__ = (
        Index('IX_CALCULATION_AREA_DEPARTMENT', 'DEPARTMENT_ID', 'CALC_AREA_ID', unique=True),
        {'schema': 'dbo'}
    )

    ID = Column(Integer, primary_key=True)
    DEPARTMENT_ID = Column(ForeignKey('dbo.HIERARCHY.HR_ID'), nullable=False)
    CALC_AREA_ID = Column(ForeignKey('dbo.CALCULATION_AREA.CALC_AREA_ID'), nullable=False)
    DISABLED = Column(BIT, nullable=False)
    CREATED = Column(DateTime, nullable=False)
    CREATED_BY = Column(ForeignKey('dbo.STAFF.ST_ID'), nullable=False)
    UPDATED = Column(DateTime)
    ...
    STAFF = relationship('STAFF', primaryjoin='CALCULATIONAREADEPARTMENT.CREATED_BY == STAFF.ST_ID')
    HIERARCHY = relationship('HIERARCHY')
    STAFF1 = relationship('STAFF', primaryjoin='CALCULATIONAREADEPARTMENT.UPDATED_BY == STAFF.ST_ID')
...
class CATEGORYHIERARCHY(Base):
    ...
    STAFF = relationship('STAFF', primaryjoin='CATEGORYHIERARCHY.CREATED_BY == STAFF.ST_ID')
    HIERARCHY = relationship('HIERARCHY', primaryjoin='CATEGORYHIERARCHY.DEPARTMENT_ID == HIERARCHY.HR_ID')
    STAFF1 = relationship('STAFF', primaryjoin='CATEGORYHIERARCHY.UPDATED_BY == STAFF.ST_ID')
    HIERARCHY1 = relationship('HIERARCHY', primaryjoin='CATEGORYHIERARCHY.WORKING_CLUSTER_ID == HIERARCHY.HR_ID')
...
class CATEGORYWORKINGCLUSTER(Base):
    ...
    CATEGORY = relationship('CATEGORY')
    STAFF = relationship('STAFF', primaryjoin='CATEGORYWORKINGCLUSTER.CREATED_BY == STAFF.ST_ID')
    STAFF1 = relationship('STAFF', primaryjoin='CATEGORYWORKINGCLUSTER.UPDATED_BY == STAFF.ST_ID')
    HIERARCHY = relationship('HIERARCHY')
...
class CERTIFICATECLIENT(Base):
    ...
    STAFF = relationship('STAFF', primaryjoin='CERTIFICATECLIENT.CREATED_BY == STAFF.ST_ID')
    CUSTOMER = relationship('CUSTOMER')
    STAFF1 = relationship('STAFF', primaryjoin='CERTIFICATECLIENT.UPDATED_BY == STAFF.ST_ID')
...
class CHARTEMPLATE(Base):
    ...
    CATEGORY = relationship('CATEGORY')
    STAFF = relationship('STAFF', primaryjoin='CHARTEMPLATE.CREATED_BY == STAFF.ST_ID')
    MANDATOR = relationship('MANDATOR')
    STAFF1 = relationship('STAFF', primaryjoin='CHARTEMPLATE.UPDATED_BY == STAFF.ST_ID')
...
class CURRENCYRATE(Base):
    ...
    __table_args__ = (
        Index('IX_CURRENCY_RATE_VALUE', 'VALUE', 'CUR_FROM', 'CUR_TO', 'VALID_FROM'),
        Index('IX_CURRENCY_RATE_CUR_FROM_CUR_TO_VALID_FROM', 'CUR_FROM', 'CUR_TO', 'VALID_FROM', 'VALUE'),
        {'schema': 'dbo'}
    )

    CUR_FROM = Column(ForeignKey('dbo.CURRENCY.CUR_ID'), primary_key=True, nullable=False)
    CUR_TO = Column(ForeignKey('dbo.CURRENCY.CUR_ID'), primary_key=True, nullable=False)
    ...
    CURRENCY = relationship('CURRENCY', primaryjoin='CURRENCYRATE.CUR_FROM == CURRENCY.CUR_ID')
    CURRENCY1 = relationship('CURRENCY', primaryjoin='CURRENCYRATE.CUR_TO == CURRENCY.CUR_ID')


class CUSTOMERADDRES(Base):
    __tablename__ = 'CUSTOMER_ADDRESS'
    __table_args__ = (
        Index('UIX_CUSTOMER_ADDRESS_CU_ID_CA_NATION', 'CU_ID', 'CA_NATION', unique=True),
        Index('IX_CUSTOMER_ADDRESS_CA_NAME', 'CA_NAME', 'CU_ID', 'CA_NATION'),
        Index('IX_CUSTOMER_ADDRESS_CA_NATION', 'CA_NATION', 'CU_ID', 'CA_NAME'),
        Index('IX_CUSTOMER_ADDRESS_CA_NATION_CA_NAME', 'CA_NATION', 'CA_NAME', 'CU_ID', 'CA_CITY', 'CA_STREET1', 'CA_HOUSE_NUM1'),
        {'schema': 'dbo'}
    )
...
class CUSTOMERALTERNATIVE(Base):
    ...
    CUSTOMER = relationship('CUSTOMER', primaryjoin='CUSTOMERALTERNATIVE.ALTERNATIVE_ID == CUSTOMER.CU_ID')
    CUSTOMER1 = relationship('CUSTOMER', primaryjoin='CUSTOMERALTERNATIVE.CU_ID == CUSTOMER.CU_ID')


class CUSTOMERCONTACT(Base):
    __tablename__ = 'CUSTOMER_CONTACT'
    __table_args__ = (
        Index('IX_CUSTOMER_CONTACT_CU_ID_CUC_PARNR', 'CU_ID', 'CUC_PARNR', 'CUC_ID', 'CUC_FORENAME', 'CUC_SURNAME', 'CUC_PHONE', 'LOCATION', 'BUILDING', 'RUN_ID', 'CUC_DEPARTMENT_NO', 'CUC_COMMENTS', 'CUC_TITLE', 'CUC_UPDATE_TYPE', 'CUC_SERVERID', 'CUC_LAST_UPDATED', 'CUC_FAX', 'CUC_MOBILE', 'CUC_MAIL', 'CUC_SCOPE', 'CUC_DISABLE', 'CUC_DEPARTMENT'),
        {'schema': 'dbo'}
    )
...
class CUSTOMERDEFAULTPARTNER(Base):
    ...
    __table_args__ = (
        Index('UIX_CUSTOMER_DEFAULT_PARTNER_CU_ID_PRP_ID', 'CU_ID', 'PRP_ID', unique=True),
        {'schema': 'dbo'}
    )
    ...
    CUSTOMER = relationship('CUSTOMER', primaryjoin='CUSTOMERDEFAULTPARTNER.CU_ID == CUSTOMER.CU_ID')
    CUSTOMER1 = relationship('CUSTOMER', primaryjoin='CUSTOMERDEFAULTPARTNER.GLOBAL_PARTNER == CUSTOMER.CU_ID')
    CUSTOMER2 = relationship('CUSTOMER', primaryjoin='CUSTOMERDEFAULTPARTNER.GOODS_RECIPIENT == CUSTOMER.CU_ID')
    CUSTOMER3 = relationship('CUSTOMER', primaryjoin='CUSTOMERDEFAULTPARTNER.INVOICE_RECIPIENT == CUSTOMER.CU_ID')
    CUSTOMER4 = relationship('CUSTOMER', primaryjoin='CUSTOMERDEFAULTPARTNER.MANUFACTURER == CUSTOMER.CU_ID')
    PROCESSPHASE = relationship('PROCESSPHASE')
    CUSTOMER5 = relationship('CUSTOMER', primaryjoin='CUSTOMERDEFAULTPARTNER.REGULATOR == CUSTOMER.CU_ID')
    CUSTOMER6 = relationship('CUSTOMER', primaryjoin='CUSTOMERDEFAULTPARTNER.REPORT_RECIPIENT == CUSTOMER.CU_ID')
...
class DISPOPHASE(Base):
    ...
    PROCESS_PHASE = Column(ForeignKey('dbo.PROCESSPHASE.PRP_ID'), nullable=False)
    CREATED = Column(DateTime, nullable=False)
    CREATED_BY = Column(Integer, nullable=False)
    UPDATED = Column(DateTime, nullable=False)
    UPDATED_BY = Column(Integer, nullable=False)
...
class DISPOPHASEDEFAULT(Base):
    ...
    ID = Column(Integer, primary_key=True)
    CUSTOMER = Column(ForeignKey('dbo.DISPO_KNOWN_CUSTOMERS.ID'), nullable=False)
...
class DISPOPHASERULE(Base):
    ...
    ID = Column(Integer, primary_key=True)
    PHASE = Column(ForeignKey('dbo.PROCESSPHASE.PRP_ID'), nullable=False, unique=True)
...
class EMAILCONTENT(Base):
    ...
    MD_ID = Column(ForeignKey('dbo.MANDATOR.ID'), nullable=False)
    HR_ID = Column(ForeignKey('dbo.HIERARCHY.HR_ID'))
    EMAIL_SUBJECT_ID = Column(ForeignKey('dbo.EMAIL_SUBJECT.SUBJECT_ID'), nullable=False)
    ...
    STAFF = relationship('STAFF', primaryjoin='EMAILCONTENT.CREATED_BY == STAFF.ST_ID')
    EMAIL_SUBJECT = relationship('EMAILSUBJECT')
    HIERARCHY = relationship('HIERARCHY')
    MANDATOR = relationship('MANDATOR')
    STAFF1 = relationship('STAFF', primaryjoin='EMAILCONTENT.UPDATED_BY == STAFF.ST_ID')


class KEYWORDFORMAT(Base):
    __tablename__ = 'KEYWORD_FORMAT'
    __table_args__ = (
        Index('UK_FORMAT_KEYWORD_COL_TABLE', 'KEYWORD', 'COL_TABLE', unique=True),
        {'schema': 'dbo'}
    )
...
class KSTRATE(Base):
    ...
    __table_args__ = (
        Index('UIX_KST_RATE_ENTRY', 'CC_ID', 'SG_ID', 'CCR_VALID_FROM', unique=True),
        {'schema': 'dbo'}
    )
    ...
    UPDATED = Column(DateTime)
    UPDATED_BY = Column(ForeignKey('dbo.STAFF.ST_ID'))
    SG_ID = Column(ForeignKey('dbo.SKILLGROUP.SG_ID'), primary_key=True, nullable=False)
    RUN_ID = Column(ForeignKey('dbo.TASK_RUN.RUN_ID'))
    CCR_DISABLED = Column(BIT, nullable=False)

    KST = relationship('KST')
    STAFF = relationship('STAFF', primaryjoin='KSTRATE.CREATED_BY == STAFF.ST_ID')
    CURRENCY = relationship('CURRENCY')
    TASK_RUN = relationship('TASKRUN')
    SKILLGROUP = relationship('SKILLGROUP')
    STAFF1 = relationship('STAFF', primaryjoin='KSTRATE.UPDATED_BY == STAFF.ST_ID')
...
class PROCES(Base):
    ...
    __table_args__ = (
        Index('IX_PROCESS_ARCHIVING_STATUS', 'ARCHIVING_STATUS', 'PC_DISABLED'),
        Index('IX_PROCESS_PC_DISABLED_COLLECTIVE_INVOICE_SENT', 'PC_DISABLED', 'COLLECTIVE_INVOICE_SENT'),
        Index('IX_PROCESS_PC_DISABLED_PC_VISIBLE_FOR', 'PC_DISABLED', 'PC_VISIBLE_FOR', 'PC_ID'),
        {'schema': 'dbo'}
    )
    ...
    ANONYMIZATION_LOG = relationship('ANONYMIZATIONLOG')
    CUSTOMER = relationship('CUSTOMER')
    HIERARCHY = relationship('HIERARCHY', primaryjoin='PROCES.PC_CREATEDBY_TEAM == HIERARCHY.HR_NEW_ID')
    STAFF = relationship('STAFF')
    HIERARCHY1 = relationship('HIERARCHY', primaryjoin='PROCES.PC_PROJECTMANAGER_TEAM == HIERARCHY.HR_NEW_ID')
    HIERARCHY2 = relationship('HIERARCHY', primaryjoin='PROCES.PC_UPDATEBY_TEAM == HIERARCHY.HR_NEW_ID')
    PORTAL = relationship('PORTAL')
...
class PROCESSDEFAULT(Base):
    ...
    STAFF = relationship('STAFF', primaryjoin='PROCESSDEFAULT.CREATED_BY == STAFF.ST_ID')
    CUSTOMER = relationship('CUSTOMER')
    PROCESSPHASE = relationship('PROCESSPHASE')
    STAFF1 = relationship('STAFF', primaryjoin='PROCESSDEFAULT.UPDATED_BY == STAFF.ST_ID')
...
class ROLEPERMISSION(Base):
    ...
    PS_ID = Column(ForeignKey('dbo.PERMISSION.PS_ID'), primary_key=True, nullable=False)
    RS_ID = Column(ForeignKey('dbo.ROLE.RS_ID'), primary_key=True, nullable=False)
    ...
    STAFF = relationship('STAFF', primaryjoin='ROLEPERMISSION.CREATED_BY == STAFF.ST_ID')
    PERMISSION = relationship('PERMISSION')
    ROLE = relationship('ROLE')
    STAFF1 = relationship('STAFF', primaryjoin='ROLEPERMISSION.UPDATED_BY == STAFF.ST_ID')
...
class STAFFRATE(Base):
    ...
    STAFF = relationship('STAFF', primaryjoin='STAFFRATE.CREATED_BY == STAFF.ST_ID')
    CURRENCY = relationship('CURRENCY')
    STAFF1 = relationship('STAFF', primaryjoin='STAFFRATE.ST_ID == STAFF.ST_ID')
    STAFF2 = relationship('STAFF', primaryjoin='STAFFRATE.UPDATED_BY == STAFF.ST_ID')


class SURVEYNOTIFICATIONTEMPLATE(Base):
    __tablename__ = 'SURVEY_NOTIFICATION_TEMPLATE'
    __table_args__ = (
        Index('UIX_SURVEY_NOTIFICATION_TEMPLATE_HR_ID_LANGUAGE_CU_ID', 'HR_ID', 'LANGUAGE', 'CU_ID', unique=True),
        {'schema': 'dbo'}
    )
...
class TEMPLATE(Base):
    ...
    STAFF = relationship('STAFF', primaryjoin='TEMPLATE.TP_CLEARINGBY == STAFF.ST_ID')
    STAFF1 = relationship('STAFF', primaryjoin='TEMPLATE.TP_REGBY == STAFF.ST_ID')


class TESTSAMPLECHARACTERISTIC(Base):
    __tablename__ = 'TESTSAMPLECHARACTERISTICS'
    __table_args__ = (
        Index('IX_TESTSAMPLECHARACTERISTICS_TS_ID_TS_DISABLED', 'TS_ID', 'TS_DISABLED'),
        {'schema': 'dbo'}
    )
...
class TESTSAMPLEPICTURE(Base):
    ...
    __table_args__ = (
        Index('IX_TESTSAMPLEPICTURE_TS_ID_TS_DISABLED', 'TS_ID', 'TS_DISABLED'),
        {'schema': 'dbo'}
    )
...
class WORKFLOWASSIGNMENT(Base):
    ...
    WA_ASSIGNED_TO = Column(ForeignKey('dbo.STAFF.ST_ID'), nullable=False, index=True)
    ...
    STAFF = relationship('STAFF', primaryjoin='WORKFLOWASSIGNMENT.WA_ACCEPTED_BY == STAFF.ST_ID')
    STAFF1 = relationship('STAFF', primaryjoin='WORKFLOWASSIGNMENT.WA_ASSIGNED_TO == STAFF.ST_ID')
    STAFF2 = relationship('STAFF', primaryjoin='WORKFLOWASSIGNMENT.WA_CREATED_BY == STAFF.ST_ID')
    STAFF3 = relationship('STAFF', primaryjoin='WORKFLOWASSIGNMENT.WA_UPDATED_BY == STAFF.ST_ID')
...
class ZPSZERTTYPE(Base):
    ...
    ZETY_ZEGE_ID = Column(ForeignKey('dbo.ZPS_ZERTIFIZIERGEBIET.ZEGE_ID'), nullable=False)
    CREATED = Column(DateTime, nullable=False)
    CREATED_BY = Column(ForeignKey('dbo.STAFF.ST_ID'), nullable=False)
    UPDATED = Column(DateTime)
    UPDATED_BY = Column(ForeignKey('dbo.STAFF.ST_ID'))

    STAFF = relationship('STAFF', primaryjoin='ZPSZERTTYPE.CREATED_BY == STAFF.ST_ID')
    STAFF1 = relationship('STAFF', primaryjoin='ZPSZERTTYPE.UPDATED_BY == STAFF.ST_ID')
...
class ZVAUFTRAGSPO(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(['VBELN', 'MD_ID', 'SERVERID'], ['dbo.ZVAUFTRAG_KOPF.VBELN', 'dbo.ZVAUFTRAG_KOPF.MD_ID', 'dbo.ZVAUFTRAG_KOPF.SERVERID']),
        {'schema': 'dbo'}
    )
...
class ZVAUFTRAGFREISCHALT(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(['BEARBAUFNR', 'MD_ID', 'SERVERID'], ['dbo.ZVAUFTRAG_KOPF.VBELN', 'dbo.ZVAUFTRAG_KOPF.MD_ID', 'dbo.ZVAUFTRAG_KOPF.SERVERID']),
        {'schema': 'dbo'}
    )
...
class ZVAUFTRAGPARTNER(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(['VBELN', 'MD_ID', 'SERVERID'], ['dbo.ZVAUFTRAG_KOPF.VBELN', 'dbo.ZVAUFTRAG_KOPF.MD_ID', 'dbo.ZVAUFTRAG_KOPF.SERVERID']),
        Index('IX_ZVAUFTRAG_PARTNER_MD_ID', 'MD_ID', 'VBELN', 'PARVW', 'KUNNR', 'PARNR', 'SERVERID', 'PERNR'),
        {'schema': 'dbo'}
    )
...
class ZVAUFTRAGTEXTE(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(['VBELN', 'MD_ID', 'SERVERID'], ['dbo.ZVAUFTRAG_KOPF.VBELN', 'dbo.ZVAUFTRAG_KOPF.MD_ID', 'dbo.ZVAUFTRAG_KOPF.SERVERID']),
        Index('IX_ZVAUFTRAG_TEXTE_MD_ID_VBELN_LAISO_ID', 'MD_ID', 'VBELN', 'LAISO', 'ID', 'TDLINE', 'TDOBJECT', 'TDID'),
        Index('IX_ZVAUFTRAG_TEXTE_LAISO_VBELN_MD_ID', 'LAISO', 'VBELN', 'MD_ID', 'ID', 'TDLINE'),
        {'schema': 'dbo'}
    )
...
class ZVKUNDEPARTNER(Base):
    ...
    __table_args__ = (
        Index('IX_ZVKUNDE_PARTNER_ALL', 'CU_ID', 'VKORG', 'VTWEG', 'PARVW', 'PARZA', 'PHASE', unique=True),
        {'schema': 'dbo'}
    )
...
class CATEGORYWORKINGCLUSTERDEPARTMENT(Base):
    ...
    ID = Column(Integer, primary_key=True)
    CATEGORY_WORKING_CLUSTER_ID = Column(ForeignKey('dbo.CATEGORY_WORKING_CLUSTER.ID'), nullable=False)
    DEPARTMENT_ID = Column(ForeignKey('dbo.HIERARCHY.HR_ID'), nullable=False)
    DISABLED = Column(BIT, nullable=False)
    CREATED = Column(DateTime, nullable=False)
    CREATED_BY = Column(ForeignKey('dbo.STAFF.ST_ID'), nullable=False)
    ...
    STAFF = relationship('STAFF', primaryjoin='CATEGORYWORKINGCLUSTERDEPARTMENT.CREATED_BY == STAFF.ST_ID')
    HIERARCHY = relationship('HIERARCHY')
    STAFF1 = relationship('STAFF', primaryjoin='CATEGORYWORKINGCLUSTERDEPARTMENT.UPDATED_BY == STAFF.ST_ID')
...
class KALKUNTERMODUL(Base):
    ...
    STAFF = relationship('STAFF', primaryjoin='KALKUNTERMODUL.KALUM_CREATED_BY == STAFF.ST_ID')
    STAFF1 = relationship('STAFF', primaryjoin='KALKUNTERMODUL.KALUM_UPDATED_BY == STAFF.ST_ID')
...
class PROJECT(Base):
    ...
    __table_args__ = (
        Index('IX_PROJECT_MD_ID_P_PROJECTMANAGER_P_DATE_READY_P_DISABLED_P_DEADLINE_P_PROCESSPHASE', 'MD_ID', 'P_PROJECTMANAGER', 'P_DATE_READY', 'P_DISABLED', 'P_DEADLINE', 'P_PROCESSPHASE'),
        Index('IX_PROJECT_IAN_SEARCH', 'P_DISABLED', 'P_WC_ID', 'P_IAN', 'P_MODEL', 'P_ID', 'P_PREDATE', 'P_DEADLINE', 'P_CUSTOMER_A'),
        Index('IX_PROJECT_MD_ID_P_TRANSFERPROJECT_P_DISABLED_P_ZARA_NUMBER_P_IS_OLD_PROJECT', 'MD_ID', 'P_TRANSFERPROJECT', 'P_DISABLED', 'P_ZARA_NUMBER', 'P_IS_OLD_PROJECT', 'P_CUR_ID', 'P_FOREIGN_CURRENCY', 'P_PRICING_DATE'),
        Index('IX_PROJECT_MD_ID_P_DISABLED_P_WC_ID', 'MD_ID', 'P_DISABLED', 'P_WC_ID', 'P_ID', 'PC_ID', 'P_ZARA_NUMBER', 'P_FOLDER', 'P_PRODUCT', 'P_MODEL', 'P_DATE_DONE', 'P_URGENT', 'P_INTERN', 'P_TRANSFERPROJECT', 'P_TRANSFERSUBORDER', 'P_CUR_ID', 'E_ID', 'P_TUV_CERT_EXISTS', 'P_EXTERNAL_CERT_EXISTS', 'P_IS_QUOTATION', 'P_IS_OLD_PROJECT', 'CC_ID', 'P_VERTRIEBSWEG', 'P_PROJECT_NUMBER', 'SAP_QUOTATION_NUMBER', 'P_SAP_INDUSTRY', 'P_FOREIGN_CURRENCY', 'P_EXCHANGE_RATE', 'P_PRICING_DATE', 'CRM_ID', 'CATEGORY_ID'),
        Index('IX_PROJECT_SURVEY_NOTIFICATION', 'P_INTERN', 'P_DISABLED', 'P_IS_QUOTATION', 'PERFORM_SURVEY', 'SURVEY_SENT', 'P_ZARA_NUMBER', 'P_DATE_DONE', 'CATEGORY_ID', 'P_ID', 'MD_ID', 'PC_ID', 'P_CUSTOMER_A', 'P_CUSTOMER_B', 'P_ORDERSIZE', 'P_WC_ID', 'P_PROJECTMANAGER_TEAM', 'P_CONTACT_CUC_ID', 'MANUFACTURER_CONTACT'),
        Index('IX_PROJECT_P_DISABLED_P_WC_ID', 'P_DISABLED', 'P_WC_ID', 'P_ID', 'P_ZARA_NUMBER', 'P_IS_QUOTATION', 'SAP_QUOTATION_NUMBER'),
        Index('IX_PROJECT_P_TRANSFERPROJECT_P_ZARA_NUMBER_MD_ID_P_DISABLED', 'P_TRANSFERPROJECT', 'P_ZARA_NUMBER', 'MD_ID', 'P_DISABLED'),
        Index('IX_PROJECT_MD_ID_P_DATE_DONE_P_TRANSFERPROJECT_P_DISABLED_P_IS_OLD_PROJECT', 'MD_ID', 'P_DATE_DONE', 'P_TRANSFERPROJECT', 'P_DISABLED', 'P_IS_OLD_PROJECT'),
        Index('IX_PROJECT_P_WC_ID_MD_ID_P_DISABLED', 'P_WC_ID', 'MD_ID', 'P_DISABLED', 'P_ID', 'PC_ID', 'P_ZARA_NUMBER', 'P_NAME', 'P_FOLDER', 'P_CUSTOMER_A', 'P_PRODUCT', 'P_MODEL', 'P_PROJECTMANAGER', 'P_HANDLEDBY', 'P_DATE_APPOINTMENT', 'P_DATE_READY', 'P_DATE_CHECK', 'P_DEADLINE', 'P_DATE_DONE', 'P_ACTION', 'P_URGENT', 'P_ORDERSIZE', 'P_FORECAST', 'P_INTERN', 'P_PREDATE', 'P_REGDATE', 'P_TRANSFERPROJECT', 'P_TRANSFERSUBORDER', 'P_CUR_ID', 'E_ID', 'P_HANDLEDBY_TEAM', 'P_PROJECTMANAGER_TEAM', 'P_TUV_CERT_EXISTS', 'P_EXTERNAL_CERT_EXISTS', 'P_IS_QUOTATION', 'P_IS_OLD_PROJECT', 'CC_ID', 'P_QUOTATION_LINK', 'P_VERTRIEBSWEG', 'SAP_QUOTATION_NUMBER', 'P_FOREIGN_CURRENCY', 'P_EXCHANGE_RATE', 'P_GLOBAL_PARTNER', 'P_PRICING_DATE', 'P_REMARK', 'P_COORDINATOR', 'P_AUDIT_DATE', 'P_AUDIT_DATE_IS_CONFIRMED', 'CATEGORY_ID'),
        Index('IX_PROJECT_ARCHIVING_STATUS_P_DISABLED', 'ARCHIVING_STATUS', 'P_DISABLED'),
    ...
    P_POSTING_DONE_DATE = Column(DateTime)
    CATEGORY_ID = Column(ForeignKey('dbo.CATEGORY.ID'), nullable=False, index=True)
    P_DATE_READY_REASON = Column(Unicode(512))
    P_DATE_READY_CHANGED = Column(DateTime)
    P_DATE_CHECK_REASON = Column(Unicode(512))
    P_DATE_CHECK_CHANGED = Column(DateTime)
    ...
    MANDATOR = relationship('MANDATOR')
    HIERARCHY = relationship('HIERARCHY', primaryjoin='PROJECT.P_CHECKBY_TEAM == HIERARCHY.HR_NEW_ID')
    CURRENCY = relationship('CURRENCY', primaryjoin='PROJECT.P_CUR_ID == CURRENCY.CUR_ID')
    HIERARCHY1 = relationship('HIERARCHY', primaryjoin='PROJECT.P_DONEBY_TEAM == HIERARCHY.HR_NEW_ID')
    TESTSAMPLE = relationship('TESTSAMPLE')
    CURRENCY1 = relationship('CURRENCY', primaryjoin='PROJECT.P_FOREIGN_CURRENCY == CURRENCY.CUR_ID')
    HIERARCHY2 = relationship('HIERARCHY', primaryjoin='PROJECT.P_HANDLEDBY_TEAM == HIERARCHY.HR_NEW_ID')
    CUSTOMER = relationship('CUSTOMER')
    HIERARCHY3 = relationship('HIERARCHY', primaryjoin='PROJECT.P_PROJECTMANAGER_TEAM == HIERARCHY.HR_NEW_ID')
    parent = relationship('PROJECT', remote_side=[P_ID])
    HIERARCHY4 = relationship('HIERARCHY', primaryjoin='PROJECT.P_READYBY_TEAM == HIERARCHY.HR_NEW_ID')
    HIERARCHY5 = relationship('HIERARCHY', primaryjoin='PROJECT.P_REGBY_TEAM == HIERARCHY.HR_NEW_ID')
    STAFF = relationship('STAFF', primaryjoin='PROJECT.P_RESPONSIBLE_AGENT == STAFF.ST_ID')
    STAFF1 = relationship('STAFF', primaryjoin='PROJECT.P_SALES_REPRESENTATIVE == STAFF.ST_ID')
    STAFF2 = relationship('STAFF', primaryjoin='PROJECT.P_SIGNATURE_LEFT == STAFF.ST_ID')
    STAFF3 = relationship('STAFF', primaryjoin='PROJECT.P_SIGNATURE_RIGHT == STAFF.ST_ID')
    HIERARCHY6 = relationship('HIERARCHY', primaryjoin='PROJECT.P_TEAM_ID == HIERARCHY.HR_ID')
    HIERARCHY7 = relationship('HIERARCHY', primaryjoin='PROJECT.P_UPDATEBY_TEAM == HIERARCHY.HR_NEW_ID')
    ZVVERTRIEBSWEG = relationship('ZVVERTRIEBSWEG')
    PORTAL = relationship('PORTAL')
    HIERARCHY8 = relationship('HIERARCHY', primaryjoin='PROJECT.P_WC_ID == HIERARCHY.HR_ID')
...
class TCPROJECTPOSITION(Base):
    ...
    __table_args__ = (
        Index('UC_TC_PROJECT_POSITION_P_ID_PP_NUMBER', 'P_ID', 'PP_NUMBER', unique=True),
        {'schema': 'dbo'}
    )
...
class ZVAUFTRAGSPOSFAKT(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(['VBELN', 'POSNR', 'SERVERID', 'MD_ID'], ['dbo.ZVAUFTRAGSPOS.VBELN', 'dbo.ZVAUFTRAGSPOS.POSNR', 'dbo.ZVAUFTRAGSPOS.SERVERID', 'dbo.ZVAUFTRAGSPOS.MD_ID']),
        {'schema': 'dbo'}
    )
...
class ACCOUNTING(Base):
    ...
    __table_args__ = (
        Index('IX_ACCOUNTING_P_ID_SO_NUMBER_ACO_DISABLED', 'P_ID', 'SO_NUMBER', 'ACO_DISABLED', 'ACO_MEASURE', 'ACO_UNITS', 'ACO_DIVERGENT_RATE'),
        Index('IX_ACCOUNTING_P_ID_SO_NUMBER', 'P_ID', 'SO_NUMBER'),
        Index('UIX_ACCOUNTING_ZAPFI_ID_ACO_DISABLED', 'ZAPFI_ID', 'ACO_DISABLED', unique=True),
        {'schema': 'dbo'}
    )
    ...
    STAFF = relationship('STAFF', primaryjoin='ACCOUNTING.ACO_REGBY == STAFF.ST_ID')
    HIERARCHY = relationship('HIERARCHY', primaryjoin='ACCOUNTING.ACO_REGBY_TEAM == HIERARCHY.HR_NEW_ID')
    HIERARCHY1 = relationship('HIERARCHY', primaryjoin='ACCOUNTING.ACO_UPDATEBY_TEAM == HIERARCHY.HR_NEW_ID')
    ANONYMIZATION_LOG = relationship('ANONYMIZATIONLOG')
    KST = relationship('KST')
    CURRENCY = relationship('CURRENCY')
    PROJECT = relationship('PROJECT')
    REASON_FOR_ADDITIONAL_EFFORT = relationship('REASONFORADDITIONALEFFORT')
    STAFF1 = relationship('STAFF', primaryjoin='ACCOUNTING.ST_ID == STAFF.ST_ID')
    STAFF2 = relationship('STAFF', primaryjoin='ACCOUNTING.ST_ID_SAPOK == STAFF.ST_ID')
    HIERARCHY2 = relationship('HIERARCHY', primaryjoin='ACCOUNTING.ST_ID_TEAM == HIERARCHY.HR_NEW_ID')


class CALENDARENTRY(Base):
    __tablename__ = 'CALENDAR_ENTRY'
    __table_args__ = (
        Index('IX_CALENDAR_ENTRY_P_ID_SO_NUMBER_DISABLED', 'P_ID', 'SO_NUMBER', 'DISABLED', 'TRANSFER_STATUS'),
        {'schema': 'dbo'}
    )
    ...
    STAFF = relationship('STAFF', primaryjoin='CALENDARENTRY.CREATED_BY == STAFF.ST_ID')
    PROJECT = relationship('PROJECT')
    STAFF1 = relationship('STAFF', primaryjoin='CALENDARENTRY.ST_ID == STAFF.ST_ID')
    STAFF2 = relationship('STAFF', primaryjoin='CALENDARENTRY.UPDATED_BY == STAFF.ST_ID')


class CERTIFICATE(Base):
    __tablename__ = 'CERTIFICATE'
    __table_args__ = (
        Index('UIX_CERTIFICATE_P_ID_SO_NUMBER_MAIN_CERTIFICATE', 'P_ID', 'SO_NUMBER', 'MAIN_CERTIFICATE', unique=True),
        {'schema': 'dbo'}
    )
    ...
    STAFF = relationship('STAFF', primaryjoin='CERTIFICATE.CREATED_BY == STAFF.ST_ID')
    PROJECT = relationship('PROJECT')
    STAFF1 = relationship('STAFF', primaryjoin='CERTIFICATE.UPDATED_BY == STAFF.ST_ID')
...
class FAZ(Base):
    __tablename__ = 'FAZ'
    __table_args__ = (
        Index('IX_FAZ_P_ID_SO_NUMBER_FAZ_DISABLED', 'P_ID', 'SO_NUMBER', 'FAZ_DISABLED'),
        {'schema': 'dbo'}
    )
...
class KALKUNTERMODULBEARBEITER(Base):
    ...
    ID = Column(Integer, primary_key=True)
    KALUM_ID = Column(ForeignKey('dbo.KALKUNTERMODUL.KALUM_ID'), nullable=False)
...
class PROJECTAPPLICATIONFORM(Base):
    ...
    ID = Column(Integer, primary_key=True)
    P_ID = Column(ForeignKey('dbo.PROJECT.P_ID'), nullable=False)
    APPLICATION_FORM = Column(ForeignKey('dbo.APPLICATION_FORM.ID'), nullable=False)
    DISABLED = Column(BIT, nullable=False)
    CREATED = Column(DATETIME2, nullable=False)
    CREATED_BY = Column(ForeignKey('dbo.STAFF.ST_ID'), nullable=False)
    UPDATED = Column(DATETIME2)
    ...
    STAFF = relationship('STAFF', primaryjoin='PROJECTAPPLICATIONFORM.CREATED_BY == STAFF.ST_ID')
    PROJECT = relationship('PROJECT')
    STAFF1 = relationship('STAFF', primaryjoin='PROJECTAPPLICATIONFORM.UPDATED_BY == STAFF.ST_ID')
...
class PROJECTEDOCBASEREL(Base):
    ...
    STAFF = relationship('STAFF', primaryjoin='PROJECTEDOCBASEREL.CREATED_BY == STAFF.ST_ID')
    PROJECT = relationship('PROJECT')
    STAFF1 = relationship('STAFF', primaryjoin='PROJECTEDOCBASEREL.UPDATED_BY == STAFF.ST_ID')
...
class PROJECTPOSITION(Base):
    ...
    __table_args__ = (
        Index('IX_PROJECT_POSITION_P_ID_PP_DISABLED', 'P_ID', 'PP_DISABLED', 'PP_DISCOUNT'),
        {'schema': 'dbo'}
    )
    ...
    STAFF = relationship('STAFF', primaryjoin='PROJECTPOSITION.PP_CREATED_BY == STAFF.ST_ID')
    PLANT = relationship('PLANT')
    STAFF1 = relationship('STAFF', primaryjoin='PROJECTPOSITION.PP_STATUS_CHANGED_BY == STAFF.ST_ID')
    STAFF2 = relationship('STAFF', primaryjoin='PROJECTPOSITION.PP_UPDATED_BY == STAFF.ST_ID')
    PROJECT = relationship('PROJECT')
...
class PROKALKMODUL(Base):
    ...
    ANONYMIZATION_LOG = relationship('ANONYMIZATIONLOG')
    HIERARCHY = relationship('HIERARCHY', primaryjoin='PROKALKMODUL.MIT_ID_TEAM == HIERARCHY.HR_NEW_ID')
    HIERARCHY1 = relationship('HIERARCHY', primaryjoin='PROKALKMODUL.PKM_REGBY_TEAM == HIERARCHY.HR_NEW_ID')
    HIERARCHY2 = relationship('HIERARCHY', primaryjoin='PROKALKMODUL.PKM_UPDATEBY_TEAM == HIERARCHY.HR_NEW_ID')
    PROJECT = relationship('PROJECT')
...
class SUBORDER(Base):
    ...
    __table_args__ = (
        Index('IX_SUBORDERS_ST_ID_SO_DATE_READY_SO_DISABLED_SO_DEADLINE', 'ST_ID', 'SO_DATE_READY', 'SO_DISABLED', 'SO_DEADLINE'),
        Index('IX_SUBORDERS_ST_ID_SO_DATE_READY_SO_DATE_CHECK_SO_DISABLED', 'ST_ID', 'SO_DATE_READY', 'SO_DATE_CHECK', 'SO_DISABLED'),
        Index('IX_SUBORDERS_ST_ID_SO_DATE_CHECK_SO_DISABLED', 'ST_ID', 'SO_DATE_CHECK', 'SO_DISABLED'),
        Index('IX_SUBORDERS_SO_DATE_READY_SO_DEADLINE_SO_DISABLED', 'SO_DATE_READY', 'SO_DEADLINE', 'SO_DISABLED'),
        Index('IX_SUBORDERS_MAIN_SCREEN_SEARCH', 'P_ID', 'ST_ID', 'SO_DISABLED', 'SO_PREDATE', 'SO_NUMBER', 'SO_DEADLINE', 'SO_FORECAST', 'SO_WAIT', 'SO_IsTransferredBack', 'UA_TRANS_PROJECT', 'SO_REPORT_NUMBER', 'SO_REMARK', 'SO_POST_OUT_DATE', 'SO_CONFIRMED_DATE', 'SO_DATE_READY', 'SO_DATE_CHECK'),
        Index('IX_SUBORDERS_SO_DISABLED', 'SO_DISABLED', 'P_ID', 'SO_NUMBER', 'ST_ID', 'SO_DEADLINE', 'SO_DATE_READY', 'ST_ID_TEAM', 'BANF_REQUEST', 'BANF_ORDER', 'SO_COORDINATOR', 'SO_POSTING_DONE_DATE', 'UA_TRANS_PROJECT', 'SO_Docu_Done', 'SO_CUSTOMER_A', 'SO_CUSTOMER_B', 'SO_APPOINTMENTDATE', 'SAP_NO', 'SO_DATE_CHECK', 'SO_FORECAST', 'RES_ID', 'SO_PREDATE', 'SO_WAIT', 'SO_IsTransferredBack'),
        Index('IX_SUBORDERS_ST_ID_SO_DISABLED', 'ST_ID', 'SO_DISABLED', 'P_ID', 'SO_NUMBER', 'SO_DEADLINE', 'SO_DATE_READY', 'UA_TRANS_PROJECT', 'SO_CONFIRMED_DATE', 'SO_DATE_CHECK', 'SO_FORECAST', 'SO_PREDATE', 'SO_WAIT', 'SO_IsTransferredBack', 'SO_COORDINATOR', 'ST_ID_TEAM', 'SO_REPORT_NUMBER', 'ZM_ID', 'SO_REMARK', 'SO_POST_OUT_DATE'),
        {'schema': 'dbo'}
    )

    P_ID = Column(ForeignKey('dbo.PROJECT.P_ID'), primary_key=True, nullable=False)
    ...
    HIERARCHY = relationship('HIERARCHY', primaryjoin='SUBORDER.SO_CHECKBY_TEAM == HIERARCHY.HR_NEW_ID')
    HIERARCHY1 = relationship('HIERARCHY', primaryjoin='SUBORDER.SO_DISPOBY_TEAM == HIERARCHY.HR_NEW_ID')
    HIERARCHY2 = relationship('HIERARCHY', primaryjoin='SUBORDER.SO_READYBY_TEAM == HIERARCHY.HR_NEW_ID')
    HIERARCHY3 = relationship('HIERARCHY', primaryjoin='SUBORDER.SO_REGBY_TEAM == HIERARCHY.HR_NEW_ID')
    HIERARCHY4 = relationship('HIERARCHY', primaryjoin='SUBORDER.SO_UPDATEBY_TEAM == HIERARCHY.HR_NEW_ID')
    HIERARCHY5 = relationship('HIERARCHY', primaryjoin='SUBORDER.ST_ID_TEAM == HIERARCHY.HR_NEW_ID')
...
class SUBORDERLAGERELEMENT(Base):
    ...
    STAFF = relationship('STAFF', primaryjoin='SUBORDERLAGERELEMENT.CREATED_BY == STAFF.ST_ID')
    PROJECT = relationship('PROJECT')
    STAFF1 = relationship('STAFF', primaryjoin='SUBORDERLAGERELEMENT.UPDATED_BY == STAFF.ST_ID')
...
class SUBORDERLIMSIMAGE(Base):
    ...
    STAFF = relationship('STAFF', primaryjoin='SUBORDERLIMSIMAGE.CREATED_BY == STAFF.ST_ID')
    PROJECT = relationship('PROJECT')
    STAFF1 = relationship('STAFF', primaryjoin='SUBORDERLIMSIMAGE.UPDATED_BY == STAFF.ST_ID')
...
class SUBORDERSAMPLE(Base):
    ...
    STAFF = relationship('STAFF', primaryjoin='SUBORDERSAMPLE.CREATED_BY == STAFF.ST_ID')
    PROJECT = relationship('PROJECT')
    STAFF1 = relationship('STAFF', primaryjoin='SUBORDERSAMPLE.UPDATED_BY == STAFF.ST_ID')
...
class SUBORDERTESTMETHOD(Base):
    ...
    STAFF = relationship('STAFF', primaryjoin='SUBORDERTESTMETHOD.CREATED_BY == STAFF.ST_ID')
    PROJECT = relationship('PROJECT')
    LIMS_TEST_METHOD = relationship('LIMSTESTMETHOD')
    STAFF1 = relationship('STAFF', primaryjoin='SUBORDERTESTMETHOD.UPDATED_BY == STAFF.ST_ID')
...
class TCPROKALKUNTERMODUL(Base):
    ...
    ZM_ID = Column(Unicode(18))
    PKUM_PLANNED_EXPENSES_EXTERNAL = Column(DECIMAL(18, 2), nullable=False, server_default=text("((0))"))
...
class VERIFICATIONDOCUMENT(Base):
    ...
    __table_args__ = (
        Index('IX_VERIFICATION_DOCUMENT_P_ID_VD_DISABLED', 'P_ID', 'VD_DISABLED'),
        {'schema': 'dbo'}
    )
    ...
    PROJECT = relationship('PROJECT')
    STAFF = relationship('STAFF', primaryjoin='VERIFICATIONDOCUMENT.VD_CREATED_BY == STAFF.ST_ID')
    STAFF1 = relationship('STAFF', primaryjoin='VERIFICATIONDOCUMENT.VD_UPDATED_BY == STAFF.ST_ID')
...
class ACOIDOCEXPORT(Base):
    ...
    ID = Column(Integer, primary_key=True)
    ACO_ID = Column(ForeignKey('dbo.ACCOUNTING.ACO_ID'), nullable=False, index=True)
    CREATED = Column(DateTime, nullable=False)
    STATUS = Column(Unicode(10))
...
class MHSPROJECTDATACODE(Base):
    ...
    __table_args__ = (
        Index('IX_MHS_PROJECTDATA_CODE', 'MHSPROJECTDATA', 'CODE', unique=True),
        {'schema': 'dbo'}
    )

    ID = Column(Integer, primary_key=True)
    MHSPROJECTDATA = Column(ForeignKey('dbo.MHS_PROJECTDATA.ID'), nullable=False)
...
class MHSPROJECTDATALANGUAGE(Base):
    ...
    __table_args__ = (
        Index('IX_MHS_PROJECTDATA_LANGUAGE', 'MHSPROJECTDATA', 'LANGUAGE', unique=True),
        {'schema': 'dbo'}
    )
...
class MHSPROJECTDATASPECIAL(Base):
    ...
    __table_args__ = (
        Index('IX_MHS_PROJECTDATA_SPECIAL', 'MHSPROJECTDATA', 'SPECIAL', unique=True),
        {'schema': 'dbo'}
    )
...
class PROKALKUNTERMODUL(Base):
    ...
    __table_args__ = (
        Index('IX_PROKALKUNTERMODUL_PKUM_DISABLED', 'PKUM_DISABLED', 'P_ID', 'SO_NUMBER', 'PKUM_PLANNED_HOURS', 'PKUM_NAME'),
        Index('IX_PROKALKUNTERMODUL_PKM_ID_PKUM_DISABLED', 'PKM_ID', 'PKUM_DISABLED'),
        Index('IX_PROKALKUNTERMODUL_P_ID_SO_NUMBER', 'P_ID', 'SO_NUMBER', 'PKUM_DISABLED', 'PKUM_SP_PRICELIST', 'PKUM_SP_PRICELIST_ORG', 'PKUM_CANCELLED', 'PKUM_PLANNED_HOURS'),
        {'schema': 'dbo'}
    )
    ...
    STAFF = relationship('STAFF', primaryjoin='PROKALKUNTERMODUL.PKUM_CREATED_BY == STAFF.ST_ID')
    PROJECT_POSITION = relationship('PROJECTPOSITION', primaryjoin='PROKALKUNTERMODUL.PKUM_QUOTATION_POSITION == PROJECTPOSITION.PP_ID')
    PROJECT_POSITION1 = relationship('PROJECTPOSITION', primaryjoin='PROKALKUNTERMODUL.PKUM_TESTING_POSITION == PROJECTPOSITION.PP_ID')
    STAFF1 = relationship('STAFF', primaryjoin='PROKALKUNTERMODUL.PKUM_UPDATED_BY == STAFF.ST_ID')
    PROJECT = relationship('PROJECT')
    STAFF2 = relationship('STAFF', primaryjoin='PROKALKUNTERMODUL.ST_ID == STAFF.ST_ID')
    TEMPLATE = relationship('TEMPLATE')
...
class SUBORDERTESTREQUIREMENTSAMPLE(Base):
    ...
    ID = Column(Integer, primary_key=True)
    METHOD_ID = Column(ForeignKey('dbo.SUBORDER_TEST_METHOD.ID'), nullable=False)
    ...
    STAFF = relationship('STAFF', primaryjoin='SUBORDERTESTREQUIREMENTSAMPLE.CREATED_BY == STAFF.ST_ID')
    SUBORDER_TEST_METHOD = relationship('SUBORDERTESTMETHOD')
    SUBORDER_SAMPLE = relationship('SUBORDERSAMPLE')
    STAFF1 = relationship('STAFF', primaryjoin='SUBORDERTESTREQUIREMENTSAMPLE.UPDATED_BY == STAFF.ST_ID')
