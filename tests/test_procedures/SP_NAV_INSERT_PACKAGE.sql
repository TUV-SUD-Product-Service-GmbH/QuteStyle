...
--				<Eingabewerte sind die ID der zu ergänzenden Konfiguration, die ID des einzufügenden Pakets und die ID des Users der die Prozedur aufruft>
-- =============================================
CREATE PROCEDURE [dbo].[SP_NAV_INSERT_PACKAGE]
