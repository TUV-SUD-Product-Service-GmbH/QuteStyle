...
def test_tsl_application(
    ...
    """Test tsl app."""
    assert qapp.APP_DATA.app_name == "TSL-APP"
...
def restart_app_instance(
    qapp: TslApplication, startup_threads: List[Type[StartupThread]]
) -> None:
...
def test_threading(qapp: TslApplication) -> None:
    """Test threading."""
...
def test_run_threads_function(qapp: TslApplication) -> None:
...
def test_threads_with_dependency(qapp: TslApplication) -> None:
    """
...
def test_exit_function(qapp: TslApplication) -> None:
